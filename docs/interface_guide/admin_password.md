...
**注意**: 管理者パスワード機できるはv4.3から[セキュリティ](security.md) に移動しました。
...
管理画面にログインする際のパスワードを変よりします。変よりするには、現にのパスワードを入力する必要があります。

セキュリティ上の理よりにより、 **弱いパスワードの防止**をオンにすることをお勧めします。

 **弱いパスワードの防止** がオンになっている場合、新しいパスワードの条件はで下の通り。
