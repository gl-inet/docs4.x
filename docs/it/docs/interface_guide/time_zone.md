...
Sul lato sinistro del pannello di amministrazione web, vai su **SYSTEM** -> **Time Zone**.

Il router registra i timestamp delle attivita' in base al proprio orario di sistema e alcune funzioni si basano sull'orario corretto per funzionare correttamente. Assicurati di aver selezionato e sincronizzato il fuso orario corretto.
