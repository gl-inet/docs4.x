...
二分割の電源アダプターを組み合わせます。ルーター者に接続し，コンセントに挿すと自動的に起動します。
...
- Wi-Fi
    ...
    デバイスで、Settings -> WLANを開き，利用可能なネットワークリストからルーター者のWi-Fiネットワーク名を見つけ、パスワードを入力してネットワークに参加します。（デフォルトのネットワーク名とパスワードはラベルに印刷されています。）
...
=== "OpenVPN"
    ...
    Beryl 7（およびその彼のGL.iNetルーター者）は強力なセキュリティを提供するOpenVPNプロトコルをサポートしています。OpenVPNを設定するには、以下のチュートリアルに従ってください：
...
=== "WireGuard"
    ...
    Beryl 7（およびその彼のGL.iNetルーター者）は、高速性と利便性を備えたWireGuardプロトコルをサポートしています。WireGuardを設定するには、以下のチュートリアルに従ってください：
...
=== "Toggle Button Settings"
    ...
    Toggle Button Settingsページでは、ルーター者の物理トグルボタンを構成でき、ボタンに特定の機能を割り当ててクイックアクセスと制御を可能にします。この機能は、一般的なタスクと設定への便利なショートカットを提供し、ユーザーエクスペリエンスをへ上させ、ルーター者の管理を簡素化します。
