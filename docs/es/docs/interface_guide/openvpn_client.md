...
Por lo general, primero debe visitar el sitio web oficial del proveedor de servicios VPN al que está suscrito, obtener el archivo de configuración y subirlo al router para configurarlo como cliente OpenVPN. Si no sabe cómo obtener el archivo de configuración, consulte [este enlace](#get-configuration-files-from-openvpn-service-providers) o póngase en contacto con su soporte.
...
1. Inicie sesión en su cuenta web de NordVPN [aquí](https://my.nordaccount.com/){target="_blank"}.
   ...
   Después de iniciar sesión, en el panel de Nord, haga clic en **NordVPN** en el menú izquierdo y luego en **Set up NordVPN manually**.
   ...
   Encontrará las **service credentials**. Primero debe verificar su correo electrónico para obtenerlas; después, cópielas para usarlas más adelante.
...
2. Inicie sesión en el panel de administración web del router y vaya a **VPN** -> **OpenVPN Client** -> **NordVPN**.

   Introduzca las **service credentials** obtenidas en el paso 1 (nota: **NO** son el correo electrónico ni la contraseña de su cuenta de Nord), y luego haga clic en **Save and Continue**.
...
## Obtener archivos de configuración de proveedores de servicios OpenVPN {#get-configuration-files-from-openvpn-service-providers}
...
??? "NordVPN"
    ...
    [Sitio web oficial](https://go.nordvpn.net/aff_c?offer_id=15&aff_id=12016&url_id=902){target="_blank"}
    ...
    [Enlace de referencia](https://support.nordvpn.com/Connectivity/Router/1047409122/GL-iNet-setup-with-NordVPN.htm){target="_blank"}
...
??? "AirVPN"
    ...
    [Sitio web oficial](https://airvpn.org/?referred_by=402389){target="_blank"}
...
??? "Astrill"
    ...
    [Sitio web oficial](https://www.astrill.com/a/dik2masnw6ig){target="_blank"}
...
??? "BolehVPN"
    ...
    [Sitio web oficial](https://www.bolehvpn.net/){target="_blank"}
    ...
    [Enlace de referencia](https://www.bolehvpn.net/clients-installations/#1487691248224-0c435dba-d612){target="_blank"}

??? "CactusVPN"
    ### CactusVPN

    [Sitio web oficial](https://billing.cactusvpn.com/aff.php?aff=2310){target="_blank"}
...
??? "Cryptostorm"
    ...
    [Sitio web oficial](https://cryptostorm.is/){target="_blank"}
...
??? "CyberGhost"
    ...
    [Sitio web oficial](https://www.cyberghostvpn.com/offer/GLiNet_rem6fdij){target="_blank"}
...
??? "ExpressVPN"
    ...
    [Sitio web oficial](https://go.expressvpn.com/c/4130682/1645813/16063){target="_blank"}
    ...
    2. En la barra de navegación izquierda, haga clic en **Set up your devices**.
    ...
    3. En **Applications**, expanda **Advanced setup** y haga clic en **Manual Configuration**.
    ...
    [Enlace de referencia](https://www.expressvpn.com/support/vpn-setup/manual-config-for-linux-with-openvpn/#download){rel="sponsored" target="_blank"}

??? "FastestVPN"
    ### FastestVPN

    [Sitio web oficial](https://go.fastestvpn.com/affiliate/pap?a_aid=5ffd2a3e9d687){target="_blank"}
    ...
    [Enlace de referencia](https://support.fastestvpn.com/tutorials/routers/gl-inet/openvpn){target="_blank"}

??? "FinchVPN"
    ### FinchVPN

    [Sitio web oficial](https://www.finchvpn.com/){target="_blank"}
...
??? "Hide.me VPN"
    ...
    [Sitio web oficial](https://hide.me/?friend=glinet){target="_blank"}
...
??? "Hotspot Shield"
    ...
    [Sitio web oficial](https://trk.aclktrkr.com/aff_c?offer_id=59&aff_id=3722){target="_blank"}
    ...
    **Nota: Los archivos de configuración Router de Hotspot Shield ya no están disponibles ni son compatibles. Los pasos siguientes se incluyen únicamente por motivos de compatibilidad heredada para quienes todavía tengan esos archivos instalados.**
    ...
    1. Vaya a [https://www.hotspotshield.com/](https://www.hotspotshield.com/){target="_blank"} y haga clic en Account. Inicie sesión si se le solicita.
    ...
    2. Vaya a [https://app.hotspotshield.com/app/hotspotshield/router](https://app.hotspotshield.com/app/hotspotshield/router){target="_blank"}
    ...
    [Enlace de referencia](https://support.hotspotshield.com/hc/en-us/articles/360038538012-How-do-I-install-Hotspot-Shield-on-my-GL-iNet-router){target="_blank"}
...
??? "IPVANISH"
    ...
    - También puede descargar archivos de configuración de servidores individuales [aquí](https://www.ipvanish.com/software/configs/){target="_blank"}, pero también tendrá que descargar **ca.ipvanish.com.crt**. Antes de subirlos al router, debe comprimir **ca.ipvanish.com.crt** y los archivos de configuración .ovpn en un archivo .zip.
    ...
    [Enlace de referencia](https://support.ipvanish.com/hc/en-us/articles/360001329813-Android-OpenVPN-Setup){target="_blank"}

??? "IVACY"
    ### IVACY

    [Sitio web oficial](https://billing.ivacy.com/page/22852){target="_blank"}
    ...
    [Enlace de referencia](https://support.ivacy.com/setup_guide/how-to-setup-ivacy-on-gl-inet-router/){target="_blank"}

??? "IVPN"
    ### IVPN

    [Sitio web oficial](https://www.ivpn.net/){target="_blank"}
    ...
    [Enlace de referencia](https://www.ivpn.net/setup/gnu-linux-terminal.html){target="_blank"}

??? "OVPN"
    ### OVPN

    [Sitio web oficial](https://www.ovpn.com/en?ref=glinet){target="_blank"}
...
??? "OysterVPN"
    ...
    [Sitio web oficial](https://go.oystervpn.net?a_aid=glinet){target="_blank"}
...
??? "PrivadoVPN"
    ...
    [Sitio web oficial](https://privadovpn.com/#a_aid=GLINET){target="_blank"}
...
??? "PrivateVPN"
    ...
    [Sitio web oficial](https://affiliate.privatevpn.com/scripts/click.php?a_aid=5e3a511658bc3){target="_blank"}

    [Descargue](https://static.gl-inet.com/docs/router/en/4/interface_guide/openvpn_client/privatevpn/PrivateVPN-TUN.zip){target="_blank"} directamente.
...
??? "Proton VPN"
    ...
    [Sitio web oficial](https://go.getproton.me/aff_c?offer_id=26&aff_id=1612){target="_blank"}
...
??? "PureVPN"
    ...
    1. [Inicie sesión en su cuenta de PureVPN.](https://my.purevpn.com/){target="_blank"}
    ...
    [Enlace de referencia](https://support.purevpn.com/openvpn-files){target="_blank"}
...
??? "SaferVPN"
    ...
    [Sitio web oficial](https://safervpn.com/?a_aid=563){target="_blank"}

    Haga clic [aquí](https://support.safervpn.com/hc/en-us/articles/360035425314-What-are-SaferVPN-s-OpenVPN-configuration-ovpn-files-for-manual-setup){target="_blank"} para descargar directamente los archivos de configuración.
...
??? "StarVPN"
    ...
    [Sitio web oficial](https://www.starvpn.com/dashboard/aff.php?aff=91){target="_blank"}
...
??? "StreamVPN"
    ...
    [Sitio web oficial](https://billing.streamvpn.com/account/signup?aff_t=aaf341756f7b94ed3f040f78292b80f1db1adf3318eacb87dd9c4ad4e08fde11a%3A2%3A%7Bs%3A6%3A%22aff_id%22%3Bs%3A6%3A%22645311%22%3Bs%3A6%3A%22off_id%22%3Bi%3A10%3B%7D){target="_blank"}
...
??? "StrongVPN"
    ...
    [Sitio web oficial](https://strongvpn.com/?tr_aid=5ac44bd241ca7){target="_blank"}
...
??? "Surfshark"
    ...
    [Enlace de referencia](https://support.surfshark.com/hc/en-us/articles/360011856259-How-to-set-up-Surfshark-on-GL-iNet-router-3-x-firmware-){target="_blank"}

??? "VPN.AC"
    ### VPN.AC

    [Sitio web oficial](https://vpn.ac/aff.php?aff=1424){target="_blank"}

    [Descargue](https://vpn.ac/ovpn/).
...
??? "VPNGate"
    ...
    [Sitio web oficial](https://www.vpngate.net/en/){target="_blank"}
...
??? "VPN Unlimited(KeepSolid)"
    ...
    [Sitio web oficial](https://keepsolid.g2afse.com/click?pid=270&offer_id=7){target="_blank"}
...
??? "Windscribe"
    ...
    1. Inicie sesión en su cuenta de Windscribe [aquí](https://windscribe.com/login?auth_required){target="_blank"} y después acceda al [OpenVPN Config Generator](https://windscribe.com/getconfig/openvpn){target="_blank"}.
    ...
    4. Después, siga [esta guía](../interface_guide/openvpn_client.md#set-up-openvpn-client-manually-for-other-providers) para continuar.

??? "ZoogVPN"
    ### ZoogVPN

    [Sitio web oficial](https://zoogvpn.com/pricing?ref=xrsyzx){target="_blank"}
