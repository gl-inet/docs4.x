# Tethering iPhone non riuscito

Se riscontri un problema con il tethering di iPhone, puoi provare i passaggi seguenti per risolverlo.
...
4. Scollega e ricollega il cavo Lightning / Type-C.

5. Usa un altro cavo USB. Assicurati che supporti il trasferimento dati (non solo la ricarica).

6. Usa l'alimentatore originale del router.

7. Riavvia sia il router sia l'iPhone. A volte riavviare l'iPhone risolve il problema di tethering.
