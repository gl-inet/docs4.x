...
Please refer to [this guide](../interface_guide/cloud.md) for details.
...
5. Set the device from which you want to remotely access your router as a WireGuard Client by importing the configuration file manually. 
    ...
    - If your WireGuard Client is another GL.iNet router, such as a GL.iNet travel router, refer to [this guide](../interface_guide/wireguard_client/#set-up-wireguard-client-manually-for-other-providers) to import the configuration file to it and start a connection.
