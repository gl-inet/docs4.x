# Puli AX (GL-XE3000) Benutzerhandbuch
...
Ein VPN (virtuelles privates Netzwerk) erstellt einen sicheren, verschlüsselten Datenverkehr zwischen Ihrem Gerät und dem VPN-Server. Es bietet eine zusätzliche Ebene für Datenschutz und Sicherheit (VPN-Client) und ermöglicht Ihnen den Zugriff auf ein entferntes Netzwerk (VPN-Server). Puli AX und andere GL.iNet-Router unterstützen OpenVPN und WireGuard. Zusätzlich wird Tor unterstützt.

=== "OpenVPN"

    Puli AX und andere GL.iNet-Router unterstützen das OpenVPN-Protokoll, das hohe Sicherheit bietet. Folgen Sie zum Einrichten von OpenVPN diesen Anleitungen:
...
=== "WireGuard"
    ...
    Puli AX und andere GL.iNet-Router unterstützen das WireGuard-Protokoll, das hohe Geschwindigkeiten und eine komfortable Nutzung bietet. Folgen Sie zum Einrichten von WireGuard diesen Anleitungen:
...
=== "Netzwerkbeschleunigung"
    ...
    Hardware acceleration bezeichnet die Verwendung spezialisierter Hardware-Komponenten, um bestimmte Aufgaben effizienter als mit Allzweck-CPUs auszuführen.
...
=== "Upgrade"
    ...
    Die Seite Upgrade dient dazu, die Firmware Ihres Routers auf die neueste Version zu aktualisieren, um Leistung, Sicherheit und Funktionsumfang zu verbessern. Diese Seite bietet folgende Upgrade-Optionen:
    ...
    * Module Online Upgrade: Prüfen Sie automatisch auf die neueste 4G/5G-Modulversion und installieren Sie diese direkt vom Server des Herstellers, was den Update-Prozess vereinfacht.
