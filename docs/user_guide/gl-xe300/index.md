...
GL-XE300（Puli）は、家庭、ビジネス、IoTソリューションに最も適なポータブル4Gスマートルーターです。OpenWrtサポート機能と大容量ストレージの互換性により、DIY IoTプロジェクトを開発するために設計されています。また、充電式バッテリーを搭載しているため、どこにでも持ち運ぶことができます！
