...
(2) l'utilisateur de l'appareil doit accepter tout brouillage radioélectrique subi, mêmes le brouillage est susceptible d'encombrer le fonctionnement.

---

Hereby, GL TECHNOLOGIES (HONG KONG) LIMITED declares that this product is in compliance with the essential requirements and other relevant provisions of EMC directive 2014/30/EU, LVD directive 2014/35/EU. A copy of the EC Declaration of Conformity (DoC) is available at [https://www.gl-inet.com/products/certificate](https://www.gl-inet.com/products/certificate){target="_blank"}.
