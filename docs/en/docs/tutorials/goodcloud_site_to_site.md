...
2. Log in to [GoodCloud](https://www.goodcloud.xyz/#/login){target="_blank"}, navigate to **Site to Site** at the left-side bar. Click **Create Network** at the upper right.
