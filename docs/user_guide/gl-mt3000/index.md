...
Beryl AX（GL-MT3000）は、Wi-Fi 6プロトコルを使用するAX3000ポケットサイズのトラベルルーターです。Beryl(GL-MT1300)のアップグレードバージョンで、MT7981B 1.3GHzデュアルコアプロセッサを搭載し、合計Wi-Fi速度を2倍で上提供します。Wi-Fiを頻繁に使用する家庭をサポートするように設計されており、旅行用にコンパクトに設計されている。
