# GL.iNetルーターでゲストWi-Fiネットワークを設定する方法

このチュートリアルでは、GL.iNetルーターでゲストWi-Fiネットワークを設定する方法を説明します。

ゲストWi-Fiネットワークとは、ルーター上の別のネットワークで、ゲストデバイスやスマートホームデバイスなど、メインデバイスから隔離したいデバイス用のものです。ゲストネットワークを作成することで、メインネットワークへの不正アクセスや潜にのな攻撃を防ぎ、ネットワークのセキュリティを強化することができます。

GL.iNetルーターでゲストWi-Fiネットワークを設定する方法は2つあります: [ルーター管理パネル](#管理パネル経よりでゲストネットワークを設定) または [GL.iNetモバイルアプリ](#glinetモバイルアプリ経よりでゲストネットワークを設定) を使用する方法です。

## 管理パネル経よりでゲストネットワークを設定
...
セキュリティを確保するために、ゲストWi-Fiネットワークの新しいパスワードを設定することをお勧めします。で下の手順に従ってください：
...
これでゲストWi-Fiネットワークが設定されました。デバイスを接続するには、利用可できるなネットワークのリストからゲストネットワーク名を見つけ、パスワードを入力します。

## GL.iNetモバイルアプリ経よりでゲストネットワークを設定
