...
4. Activez l’obfuscation VPN.
    ...
    Vous pouvez personnaliser les [paramètres d’obfuscation](../faq/amneziawg_obfuscation_parameters.md) selon vos besoins. Nous vous recommandons de conserver les réglages par défaut.
