...
![allow access wan diagram](https://static.gl-inet.com/docs/router/de/4/tutorials/allow_access_to_vpn_server_wan/allow_access_wan_diagram.jpg){class="glboxshadow gl-90-desktop"}
...
![global options](https://static.gl-inet.com/docs/router/de/4/tutorials/allow_access_to_vpn_server_wan/4.7-global-options.png){class="glboxshadow"}

Aktivieren Sie **Allow Access WAN** und klicken Sie auf **Apply**.

![allow access](https://static.gl-inet.com/docs/router/de/4/tutorials/allow_access_to_vpn_server_wan/4.7-allow-access-wan.png){class="glboxshadow"}
...
1. Melden Sie sich am webbasierten Admin Panel Ihres VPN-Clients an und gehen Sie zu **VPN** -> **VPN Dashboard**.
    ...
    ![switch mode](https://static.gl-inet.com/docs/router/de/4/tutorials/allow_access_to_vpn_server_wan/switch-mode-1.png){class="glboxshadow"}

    Wechseln Sie zu **Policy Mode** und klicken Sie auf **Apply**.

    ![switch mode](https://static.gl-inet.com/docs/router/de/4/tutorials/allow_access_to_vpn_server_wan/switch-mode-2.png){class="glboxshadow"}

    Die Seite wird aktualisiert und anschließend wie unten dargestellt angezeigt.

    ![policy mode](https://static.gl-inet.com/docs/router/de/4/tutorials/allow_access_to_vpn_server_wan/primary-tunnel.png){class="glboxshadow"}

2. Klicken Sie auf das mittlere Feld, um das Tunnel-Ziel festzulegen.

    ![tunnel target](https://static.gl-inet.com/docs/router/de/4/tutorials/allow_access_to_vpn_server_wan/select-target.png){class="glboxshadow"}
    ...
    ![exclude target](https://static.gl-inet.com/docs/router/de/4/tutorials/allow_access_to_vpn_server_wan/exclude-target.png){class="glboxshadow"}
    ...
    ![exclude target apply](https://static.gl-inet.com/docs/router/de/4/tutorials/allow_access_to_vpn_server_wan/target-apply.png){class="glboxshadow"}
    ...
    ??? "Wie erkenne ich das WAN-Subnetz meines GL.iNet-Routers?"
        ...
        ![check wan subnet](https://static.gl-inet.com/docs/router/de/4/tutorials/allow_access_to_vpn_server_wan/local-wan-details.png){class="glboxshadow gl-80-desktop"}
...
3. Klicken Sie auf das rechte Feld, um die Tunnel-Aktion festzulegen (also ob das VPN verwendet wird oder nicht).
    ...
    ![exclude target](https://static.gl-inet.com/docs/router/de/4/tutorials/allow_access_to_vpn_server_wan/select-config-1.png){class="glboxshadow"}
    ...
    ![exclude target](https://static.gl-inet.com/docs/router/de/4/tutorials/allow_access_to_vpn_server_wan/select-config-2.jpg){class="glboxshadow"}

4. Schalten Sie den Schalter oben rechts ein, um diesen VPN-Tunnel zu aktivieren. Die Verbindung wird daraufhin aufgebaut.

    ![enable vpn](https://static.gl-inet.com/docs/router/de/4/tutorials/allow_access_to_vpn_server_wan/enable_vpn.png){class="glboxshadow"}

    Warten Sie einige Minuten. Sobald die Verbindung erfolgreich hergestellt wurde, wird die Anzeige grün.

    ![vpn connected](https://static.gl-inet.com/docs/router/de/4/tutorials/allow_access_to_vpn_server_wan/vpn_connected.png){class="glboxshadow"}
    ...
    ![vpn test](https://static.gl-inet.com/docs/router/de/4/tutorials/allow_access_to_vpn_server_wan/ipcheck.png){class="glboxshadow"}
...
5. Greifen Sie auf Geräte oder Dienste im WAN-Subnetz zu und prüfen Sie, ob der Zugriff erfolgreich ist.
    ...
    ![ping test](https://static.gl-inet.com/docs/router/de/4/tutorials/allow_access_to_vpn_server_wan/ping-test.png){class="glboxshadow"}
