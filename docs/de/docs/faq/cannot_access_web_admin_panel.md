...
![can't access admin](https://static.gl-inet.com/docs/router/de/4/faq/cannot_access_web_admin_panel/cantaccessadmin.jpg){class="glboxshadow"}
...
=== "Windows 10 / Windows 11"
    ...
    ![control panel](https://static.gl-inet.com/docs/router/de/4/faq/cannot_access_web_admin_panel/control_panel_view_by.png){class="glboxshadow"}
    ...
    ![network and sharing center, connections](https://static.gl-inet.com/docs/router/de/4/faq/cannot_access_web_admin_panel/network_and_sharing_center_connections.png){class="glboxshadow"}

    Daraufhin wird ein Dialogfenster mit dem Status der Verbindung geöffnet. Klicken Sie auf die Schaltfläche "Details".

    ![network and sharing center, connections status](https://static.gl-inet.com/docs/router/de/4/faq/cannot_access_web_admin_panel/network_and_sharing_center_connections_status.png){class="glboxshadow"}
    ...
    ![network and sharing center, connections status detail](https://static.gl-inet.com/docs/router/de/4/faq/cannot_access_web_admin_panel/network_and_sharing_center_connections_status_detail.png){class="glboxshadow"}
...
=== "Windows 7"
    ...
    ![property of network on windows 7](https://static.gl-inet.com/docs/router/de/4/faq/cannot_access_web_admin_panel/property_of_network_win7.jpg){class="glboxshadow"}
...
=== "macOS"
    ...
    ![router ip of ethernet on mac os](https://static.gl-inet.com/docs/router/de/4/faq/cannot_access_web_admin_panel/router_ip_of_ethernet_on_mac_os.jpg){class="glboxshadow"}
    ...
    ![router ip of Wi-Fi on mac os](https://static.gl-inet.com/docs/router/de/4/faq/cannot_access_web_admin_panel/router_ip_of_wifi_on_mac_os.jpg){class="glboxshadow"}
...
=== "iOS"
    ...
    ![router ip address on iphone](https://static.gl-inet.com/docs/router/de/4/faq/cannot_access_web_admin_panel/router_ip_address_on_iphone.jpg){class="glboxshadow"}
