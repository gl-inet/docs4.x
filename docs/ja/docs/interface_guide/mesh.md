...
Mango 2（GL-MG1300）とMudi 7（GL-E5800）は、ファームウェアv4.10以降でもMeshに対応していません。 詳しくは[対応モデル](#supported-models)をご覧ください。
...
**Flint 3**は、インターネットに接続し、すべてのMeshノードを管理するメインルーターです。

**Slate 7**は、メインルーターのWi-Fiカバレッジを拡張するMeshノードです。
