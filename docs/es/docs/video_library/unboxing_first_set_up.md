# Unboxing y configuración inicial

Descubra nuestros dispositivos por primera vez y comprenda el proceso de configuración.
...
Video de unboxing y configuración
