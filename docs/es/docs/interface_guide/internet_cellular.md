...
Haga clic en el enlace [t-mobile device certification](https://www.t-mobile.com/business/solutions/iot/device-certification){target="_blank"} y elija 5G en **Filter** para encontrarlo.
