...
![log in](https://static.gl-inet.com/docs/router/de/4/tutorials/build_your_own_openvpn_server/router-login.jpeg){class="glboxshadow"}
...
![dynamic DNS](https://static.gl-inet.com/docs/router/de/4/tutorials/build_your_own_openvpn_server/click-dynamic-dns.jpeg){class="glboxshadow"}
...
![apply](https://static.gl-inet.com/docs/router/de/4/tutorials/build_your_own_openvpn_server/dynamic-dns-click-apply.png){class="glboxshadow"}
...
![click export](https://static.gl-inet.com/docs/router/de/4/tutorials/build_your_own_openvpn_server/click-export-client-configuration.jpeg){class="glboxshadow"}
...
![click start](https://static.gl-inet.com/docs/router/de/4/tutorials/build_your_own_openvpn_server/openvpn-server-click-start.jpeg){class="glboxshadow"}
...
??? "(Optional) Aktivieren Sie diese Einstellungen, um auf das lokale Netzwerk des VPN-Servers zuzugreifen:"
    ...
    4. Klicken Sie auf **Apply**.
        ...
        ![remote access lan](https://static.gl-inet.com/docs/router/de/4/tutorials/build_your_own_openvpn_server/toggle-enable-remote-access-lan.png){class="glboxshadow"}
    ...
    4. Klicken Sie auf **Apply**.
        ...
        ![remote access lan](https://static.gl-inet.com/docs/router/de/4/tutorials/build_your_own_openvpn_server/enable-remote-access-lan-4.8.png){class="glboxshadow"}
...
??? "Methode 1: Eine OpenVPN-Client-App eines Drittanbieters (verwenden Sie diese Methode, wenn Sie keinen zusätzlichen Router haben, der die Einrichtung eines OpenVPN-Clients unterstützt)"
    ...
    ![upload file](https://static.gl-inet.com/docs/router/de/4/tutorials/build_your_own_openvpn_server/tap-upload-file.png){class="glboxshadow"}
    6. Wählen Sie **Browse** und anschließend die zuvor heruntergeladene Konfigurationsdatei aus.
    7. Wählen Sie **OK**.
        ![tap ok](https://static.gl-inet.com/docs/router/de/4/tutorials/build_your_own_openvpn_server/tap-ok.png){class="glboxshadow"}
    8. Wählen Sie **Connect** > **OK** > **Allow**.

    Oben im VPN-Profil wird dann der Status „Connected“ angezeigt.
    ![connected status](https://static.gl-inet.com/docs/router/de/4/tutorials/build_your_own_openvpn_server/connected-status.png){class="glboxshadow"}
...
??? "Methode 2: Ein Router, der die Einrichtung eines OpenVPN-Clients unterstützt"
    ...
    ![click openvpn client](https://static.gl-inet.com/docs/router/de/4/tutorials/build_your_own_openvpn_server/click-openvpn-client.png){class="glboxshadow"}
    5. Klicken Sie auf **Add Manually**.
    ![click add manually](https://static.gl-inet.com/docs/router/de/4/tutorials/build_your_own_openvpn_server/click-add-manually.png){class="glboxshadow"}
    ...
    ![select a file](https://static.gl-inet.com/docs/router/de/4/tutorials/build_your_own_openvpn_server/click-select-a-file.png){class="glboxshadow"}
