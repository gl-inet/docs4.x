...
To set up GL-AR750, you will use one of the two supported internet connection methods: Ethernet and repeater. Watch this setup video or follow the steps below. 
...
The GL-AR750 (GL-B3000) router is an art of its own, cleverly displayed as a photo frame to house your favorite art piece and elevate your living space. Not just a visual delight to the eye, the GL-AR750 (GL-B3000) router delivers top-notch performance by featuring Wi-Fi 6 and supporting VPN capabilities.
