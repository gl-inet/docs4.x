# Guida utente di Beryl 7 (GL-MT3600BE)

## Panoramica del prodotto

Beryl 7 (GL-MT3600BE) e un router da viaggio portatile Wi-Fi 7 dual-band, progettato specificamente per scenari mobili come viaggi di lavoro e vacanze. Come versione aggiornata di Beryl AX, supporta tecnologie Wi-Fi 7 come Multi-Link Operation (MLO) e 4K QAM, con velocita teoriche dual-band fino a 688 Mbps (2,4 GHz) + 2882 Mbps (5 GHz), sufficienti per esigenze ad alta velocita come streaming 8K e gaming mobile.

Basato su processore quad-core MediaTek e dotato di 512 MB di memoria NAND flash, garantisce stabilita nel multitasking e compatibilita con vari plug-in OpenWrt. E dotato di 2 porte Ethernet da 2,5G e 1 porta USB 3.0, soddisfacendo sia le esigenze di connessioni cablate ad alta velocita sia quelle di espansione dello storage. Grazie alla compatibilita PD, puo essere alimentato con un normale cavo di ricarica per telefono, riducendo peso e ingombro nel bagaglio. Può supportare oltre 120 dispositivi collegati contemporaneamente e ha un design elegante e portatile, pensato per la mobilita.
...
Guarda qui sotto il video di unboxing di Beryl 7.
...
- Wi-Fi
    ...
    Sul dispositivo, vai in Settings -> WLAN, individua il nome della rete Wi-Fi del router nell'elenco delle reti disponibili e inserisci la password per collegarti. Le credenziali predefinite sono stampate sull'etichetta.
...
Configura Beryl 7 usando uno dei metodi di connessione Internet supportati: Ethernet, Repeater, Tethering e Cellular. Se desideri usare la funzione [Multi-WAN](../../interface_guide/multi-wan.md), configura piu di una connessione Internet.
...
=== "Ethernet"
    ...
    Collega la porta WAN di Beryl 7 a un dispositivo upstream, ad esempio un modem, tramite un cavo Ethernet.
...
=== "Tethering"
    ...
    1. Collega il dispositivo mobile, ad esempio uno smartphone o un dongle USB, alla porta USB di Beryl 7 tramite un cavo USB.
...
=== "Cellular"
    ...
    Inserisci un modem USB cellulare nella porta USB di Beryl 7. Questo metodo e utile per condividere la connessione Internet di un modem USB con tutti i dispositivi collegati.
...
Di seguito trovi una panoramica delle funzioni presenti nel pannello di amministrazione web di Beryl 7.
...
Inoltre, Beryl 7 supporta il Wi-Fi MLO, cioe Multi-Link Operation, che combina simultaneamente piu reti wireless per ottenere maggiore larghezza di banda e connessioni piu affidabili.
...
Una VPN crea traffico sicuro e crittografato tra il dispositivo e il server VPN. Offre un ulteriore livello di privacy e sicurezza come client VPN e consente di accedere a una rete remota come server VPN. Beryl 7 supporta OpenVPN, WireGuard e Tor.

=== "OpenVPN"

    Beryl 7, come gli altri router GL.iNet, supporta il protocollo OpenVPN, che offre un elevato livello di sicurezza. Per configurare OpenVPN, segui questi tutorial:
...
=== "WireGuard"
    ...
    Beryl 7, come gli altri router GL.iNet, supporta il protocollo WireGuard, che offre ottima velocita e praticita. Per configurare WireGuard, segui questi tutorial:
...
=== "Scheduled Tasks"
    ...
    * Wi-Fi Status Schedule: imposta una pianificazione per controllare la banda Wi-Fi a 5 GHz / 2,4 GHz / MLO, gestendo meglio disponibilita della rete e consumo energetico.
