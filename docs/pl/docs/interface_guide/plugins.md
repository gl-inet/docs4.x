...
W lewym panelu bocznym panelu administracyjnego przejdź do **APPLICATIONS** -> **Plug-ins**.

Ta strona umożliwia zarządzanie pakietami OpenWrt. Możesz instalować lub usuwać pakiety według potrzeb.
