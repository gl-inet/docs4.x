...
3. Gehen Sie zum Bereich **INTERNET** -> **Cellular**, klicken Sie oben rechts auf das Dreipunkt-Symbol und anschließend auf **Modem AT Command**.
    ...
    ![Modem-AT-Befehl](https://static.gl-inet.com/docs/router/de/4/tutorials/carrier_aggregation/modem-at-command.png){class="glboxshadow"}
...
4. Geben Sie im Pop-up-Fenster **AT+QCAINFO** ein und klicken Sie auf **Send**.
    ...
    ![AT+QCAINFO](https://static.gl-inet.com/docs/router/de/4/tutorials/carrier_aggregation/carrier-aggregation-info.png){class="glboxshadow"}
