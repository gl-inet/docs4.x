...
![topology](https://static.gl-inet.com/docs/router/de/4/tutorials/access_ovpnserver_lan_via_domain_names/topology_be9300_be3600.png){class="glboxshadow"}
...
![edit hosts](https://static.gl-inet.com/docs/router/de/4/tutorials/access_ovpnserver_lan_via_domain_names/edit_hosts.png){class="glboxshadow"}
...
![input ip domain](https://static.gl-inet.com/docs/router/de/4/tutorials/access_ovpnserver_lan_via_domain_names/input_ip_domain.png){class="glboxshadow gl-80-desktop"}
...
![ovpnserver options 4.8](https://static.gl-inet.com/docs/router/de/4/tutorials/access_ovpnserver_lan_via_domain_names/ovpnserver_options.png){class="glboxshadow"}

Aktivieren Sie **Allow Remote Access the LAN Subnet** und klicken Sie auf **Apply**.

![ovpnserver allow access lan 4.8](https://static.gl-inet.com/docs/router/de/4/tutorials/access_ovpnserver_lan_via_domain_names/allow_remote_access_lan.png){class="glboxshadow"}
...
![export config](https://static.gl-inet.com/docs/router/de/4/tutorials/access_ovpnserver_lan_via_domain_names/export1.png){class="glboxshadow"}
...
![export config](https://static.gl-inet.com/docs/router/de/4/tutorials/access_ovpnserver_lan_via_domain_names/export2.png){class="glboxshadow"}

Anschließend erhalten Sie eine **.ovpn**-Datei, wie unten gezeigt.

![downloads](https://static.gl-inet.com/docs/router/de/4/tutorials/access_ovpnserver_lan_via_domain_names/download.png){class="glboxshadow"}
...
![edit config](https://static.gl-inet.com/docs/router/de/4/tutorials/access_ovpnserver_lan_via_domain_names/edit_config.png){class="glboxshadow"}
...
![ovpnserver tunnel ip](https://static.gl-inet.com/docs/router/de/4/tutorials/access_ovpnserver_lan_via_domain_names/ovpnserver_tunnel_ip.png){class="glboxshadow"}
...
![start server](https://static.gl-inet.com/docs/router/de/4/tutorials/access_ovpnserver_lan_via_domain_names/ovpnserver_start.png){class="glboxshadow"}
...
![add manually](https://static.gl-inet.com/docs/router/de/4/tutorials/access_ovpnserver_lan_via_domain_names/ovpnclient_upload1.png){class="glboxshadow"}

Erstellen Sie einen Namen für diese Gruppe und laden Sie die Konfigurationsdatei hoch.

![add manually](https://static.gl-inet.com/docs/router/de/4/tutorials/access_ovpnserver_lan_via_domain_names/ovpnclient_upload2.png){class="glboxshadow"}

Der Upload war erfolgreich. Klicken Sie auf **Apply**.

![apply](https://static.gl-inet.com/docs/router/de/4/tutorials/access_ovpnserver_lan_via_domain_names/ovpnclient_upload3.png){class="glboxshadow"}

Die Konfigurationsdatei wird nun hier aufgelistet.

![applied](https://static.gl-inet.com/docs/router/de/4/tutorials/access_ovpnserver_lan_via_domain_names/ovpnclient_upload4.png){class="glboxshadow"}

### 6. VPN-Client-Verbindung starten

Klicken Sie auf das Drei-Punkte-Symbol, um die VPN-Verbindung zu starten.

![start client](https://static.gl-inet.com/docs/router/de/4/tutorials/access_ovpnserver_lan_via_domain_names/ovpnclient_start.png){class="glboxshadow"}

Wenn der graue Punkt grün wird, hat sich der OpenVPN-Client erfolgreich mit dem Server verbunden.

![ovpnclient connected](https://static.gl-inet.com/docs/router/de/4/tutorials/access_ovpnserver_lan_via_domain_names/ovpnclient_connected.png){class="glboxshadow"}
...
![ping test](https://static.gl-inet.com/docs/router/de/4/tutorials/access_ovpnserver_lan_via_domain_names/ping_test.png){class="glboxshadow"}
