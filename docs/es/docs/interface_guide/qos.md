...
**Nota**: Esta función se introdujo en el firmware v4.9. Algunos modelos, como Mango 2 (GL-MG1300), no admiten QoS debido a que no disponen de memoria suficiente, aunque ejecuten el firmware v4.9 o posterior.
