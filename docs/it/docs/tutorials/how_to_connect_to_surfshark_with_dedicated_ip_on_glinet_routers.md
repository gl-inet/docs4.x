# Come connettersi a Surfshark con un IP dedicato sui router GL.iNet?

Questo articolo illustra i passaggi per configurare una connessione Surfshark con IP dedicato sui router GL.iNet.
...
4. Fai riferimento ai link seguenti per caricare i file di configurazione sul router GL.iNet. Inserisci le credenziali se richiesto.
    ...
    - [Caricare una configurazione WireGuard](../interface_guide/wireguard_client.md#set-up-wireguard-client-manually-for-other-providers)

    - [Caricare una configurazione OpenVPN](../interface_guide/openvpn_client.md#set-up-openvpn-client-manually-for-other-providers)
