...
=== "USB Ethernet"
    ...
    Weitere Informationen zu USB-C OTG auf dem Mudi 7 finden Sie [hier](../../tutorials/what_is_usb-c_otg_and_how_to_share_your_network_via_usb-c_otg.md).
