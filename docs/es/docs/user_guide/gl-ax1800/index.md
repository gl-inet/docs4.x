# Guía de usuario de Flint (GL-AX1800)

## Descripción general del producto

Flint (GL-AX1800) es un router Wi-Fi 6 de doble banda con velocidades de conexión de hasta 600 Mbps (2,4 GHz) + 1200 Mbps (5 GHz). Su velocidad de cifrado VPN alcanza hasta 667 Mbps y puede usarse para alojar servidores VPN. Flint es ideal para transmisión de datos de alto rendimiento, conectividad masiva de dispositivos o gaming con latencia ultrabaja.
...
<small>(Este video usa un router GL.iNet diferente para mostrar la configuración, pero los pasos son los mismos para Flint y otros modelos de router.)</small>
...
Configure su Flint utilizando uno de los métodos de conexión a Internet compatibles: Ethernet, Repeater, Tethering y Cellular. Si desea usar la función [Multi-WAN](../../interface_guide/multi-wan.md), configure más de una conexión a Internet.
...
=== "Tethering"
    ...
    1. Conecte su dispositivo móvil al puerto USB del router mediante un cable USB.
...
Una VPN (red privada virtual) crea tráfico seguro y cifrado entre su dispositivo y el servidor VPN. Proporciona una capa adicional de privacidad y seguridad, como cliente VPN, y permite acceder a una red remota, como servidor VPN. Flint es compatible con OpenVPN, WireGuard y Tor.

=== "OpenVPN" 

    Flint, al igual que otros routers GL.iNet, es compatible con el protocolo OpenVPN, que ofrece una seguridad sólida. Para configurar OpenVPN, siga estos tutoriales:
...
=== "WireGuard"
    ...
    Flint, al igual que otros routers GL.iNet, es compatible con el protocolo WireGuard, que ofrece gran velocidad y comodidad. Para configurar WireGuard, siga estos tutoriales:
...
=== "Parental Control"
    ...
    Para configurar Parental Control, consulte [Parental controls](../../interface_guide/parental_control.md).
...
=== "Guest Network"
    ...
    Para configurar LAN, consulte [Lan Tutorial](../../interface_guide/guest_network.md).
...
=== "Scheduled Tasks"
    ...
    * 5GHz Wi-Fi Status Schedule: Establezca una programación para controlar la banda Wi-Fi de 5 GHz, lo que permite una mejor gestión de la disponibilidad de la red y del consumo energético.
