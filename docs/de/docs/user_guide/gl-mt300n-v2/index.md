...
![mt300n-v2 illustration](https://static.gl-inet.com/docs/router/de/4/user_guide/gl-mt300n-v2/product_info/mt300n_v2_overview.png){class="glboxshadow"}
...
=== "Ethernet"
    ...
    ![ethernet](https://static.gl-inet.com/docs/router/de/4/user_guide/gl-mt300n-v2/internet_setup/ethernet.png){class="glboxshadow"}
...
=== "Repeater"
    ...
    ![repeater](https://static.gl-inet.com/docs/router/de/4/user_guide/gl-mt300n-v2/internet_setup/repeater.png){class="glboxshadow"}
...
=== "Tethering"
    ...
    ![tethering](https://static.gl-inet.com/docs/router/de/4/user_guide/gl-mt300n-v2/internet_setup/tethering.png){class="glboxshadow"}
...
=== "Cellular"
    ...
    ![cellular](https://static.gl-inet.com/docs/router/de/4/user_guide/gl-mt300n-v2/internet_setup/usb_modem.png){class="glboxshadow"}
