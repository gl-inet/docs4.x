...
**Remarque** : cette fonction a été introduite dans le firmware v4.9. Certains modèles, tels que Mango 2 (GL-MG1300), ne prennent pas en charge la QoS en raison d’une mémoire insuffisante, même lorsqu’ils exécutent le firmware v4.9 ou une version ultérieure.
