...
![ar300m illustration](https://static.gl-inet.com/docs/router/de/4/user_guide/gl-ar300m/product_info/mt300n_v2_overview.png){class="glboxshadow"}
...
=== "Ethernet"
    ...
    ![ethernet](https://static.gl-inet.com/docs/router/de/4/user_guide/gl-ar300m/internet_setup/ethernet.png){class="glboxshadow"}
...
=== "Repeater"
    ...
    ![repeater](https://static.gl-inet.com/docs/router/de/4/user_guide/gl-ar300m/internet_setup/repeater.png){class="glboxshadow"}
...
=== "Tethering"
    ...
    ![tethering](https://static.gl-inet.com/docs/router/de/4/user_guide/gl-ar300m/internet_setup/tethering.png){class="glboxshadow"}
...
=== "Cellular"
    ...
    ![cellular](https://static.gl-inet.com/docs/router/de/4/user_guide/gl-ar300m/internet_setup/usb_modem.png){class="glboxshadow"}
