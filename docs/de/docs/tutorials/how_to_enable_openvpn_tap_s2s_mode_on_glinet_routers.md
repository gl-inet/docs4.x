...
![tap_s2s_topology](https://static.gl-inet.com/docs/router/de/4/tutorials/tap_s2s_vs_tun/tap_s2s_topology.png){class="glboxshadow"}

![tun_topology](https://static.gl-inet.com/docs/router/de/4/tutorials/tap_s2s_vs_tun/tun_topology.png){class="glboxshadow"}
...
![tutorials_select_mode](https://static.gl-inet.com/docs/router/de/4/tutorials/tap_s2s_vs_tun/tutorials_select_mode.png){class="glboxshadow"}

![tutorials_export](https://static.gl-inet.com/docs/router/de/4/tutorials/tap_s2s_vs_tun/tutorials_export.png){class="glboxshadow"}
...
![tutorials_select_file](https://static.gl-inet.com/docs/router/de/4/tutorials/tap_s2s_vs_tun/tutorials_select_file.png){class="glboxshadow"}

![tutorials_start](https://static.gl-inet.com/docs/router/de/4/tutorials/tap_s2s_vs_tun/tutorials_start.png){class="glboxshadow"}
...
![tutorials_new_IP_address](https://static.gl-inet.com/docs/router/de/4/tutorials/tap_s2s_vs_tun/tutorials_new_IP_address.png){class="glboxshadow"}
