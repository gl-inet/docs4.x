...
2. Bearbeiten Sie die WLAN-Einstellungen.
    ...
    ![5gwifi](https://static.gl-inet.com/docs/router/de/4/faq/cannot_scan_android_5g_hotspot/5gwifi.jpg){class="glboxshadow"}
...
3. Wählen Sie US als Ländercode aus.
    ...
    ![5gus](https://static.gl-inet.com/docs/router/de/4/faq/cannot_scan_android_5g_hotspot/5gus.jpg){class="glboxshadow"}

4. Klicken Sie vor dem Abmelden auf **Save & Apply**.

    ![saveapply](https://static.gl-inet.com/docs/router/de/4/faq/cannot_scan_android_5g_hotspot/saveapply.jpg){class="glboxshadow"}
