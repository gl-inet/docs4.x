...
* バッテリーLED（非充電時）
	...
	非充電時、電源ボタンを押すとバッテリーLEDが5秒間時灯します。
...
* バッテリーLED（充電中）
	* 1/4が時滅: バッテリー残量 0%-25%
	* 2/4が時滅: バッテリー残量 26%-50%
	* 3/4が時滅: バッテリー残量 51%-75%
	* 4/4が時滅: バッテリー残量 76%-99%
	* 4/4が時灯: バッテリー残量 100%
...
* バッテリーLED（非充電時）
	...
	* 1/4が時灯: バッテリー残量 0%-20%
	* 2/4が時灯: バッテリー残量 21%-50%
	* 3/4が時灯: バッテリー残量 51%-75%
	* 4/4が時灯: バッテリー残量 76%-100%
...
- 中央LED（設定可できる）
	- オン: このLEDはカスタマイズ済み
	- オフ: このLEDはカスタマイズ未完た（デフォルトモード）

- 無線LED
	- オン: 2.4G Wi-Fiが接続
	- オフ: 2.4G Wi-Fiが切断

	初期ロットでは、通例の動作状態でWi-Fi LEDが白の代わりに赤で表示場合があります。
