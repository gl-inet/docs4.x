...
**Note**: DDNS と VPN Client を同時に有効にする場合は、**Services From GL.iNet Use VPN** が無効になっていることを確認してください。この機能は、VPN Dashboard の [VPN Client Options](vpn_dashboard.md#tunnel-options) にあります。
