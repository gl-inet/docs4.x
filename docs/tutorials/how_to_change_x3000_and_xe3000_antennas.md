# Spitz AXやPuli AXの外部アンテナの取り付けまたは交換方法
...
で下のセクションを参照して、アンテナの取り付け方法や交換方法を学びましょう。
...
2. 最も適なパフォーマンスを発揮するために、アンテナを上へきに設定します。
...
ネットワーク設定をカスタマイズするために、パッケージに含まれているアンテナを交換するために独からのWi-Fiまたは5G NRアンテナを購入することができます。
適切なコネクタを持つアンテナを購入するために、で下のセクションを参照してください。
