...
Algunos modelos admiten cambiar LAN 1 a un puerto WAN para escenarios de Dual-Ethernet WAN. Puede cambiar la función del puerto LAN como se muestra a continuación. Haga clic [aquí](dual-ethernet_wan.md) para ver más detalles.
