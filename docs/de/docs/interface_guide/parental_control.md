...
> Diese Anleitung gilt für Firmware v4.8 und früher. Für neuere Versionen klicken Sie bitte [hier](parental_control_v4.9.md).

Gehen Sie im linken Bereich des Web-Admin-Panels zu **APPLICATIONS** -> **Parental Control**.
