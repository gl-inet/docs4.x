# モバイルアプリログの取なければならない方法

GL-Inetモバイルアプリの使用中に問題が発生し、モバイルアプリログを取なければならないしたい場合は、手順に従ってログを取なければならないできます。
