...
1. Melden Sie sich bei Ihrem Surfshark-Konto an und wählen Sie anschließend **Dedicated IP**.
    ...
    ![manualdip](https://static.gl-inet.com/docs/router/de/4/tutorials/surfshark_dedicated_ip/manualdip.jpg){class="glboxshadow"}

2. Klicken Sie im Abschnitt Dedicated IP auf **Settings**.

    ![setting](https://static.gl-inet.com/docs/router/de/4/tutorials/surfshark_dedicated_ip/setting.jpg){class="glboxshadow"}
...
3. Wählen Sie ein Protokoll (WireGuard oder OpenVPN) und laden Sie die Konfigurationsdateien für die manuelle Verbindung herunter.
    ...
    ![protocol](https://static.gl-inet.com/docs/router/de/4/tutorials/surfshark_dedicated_ip/protocol.jpg){class="glboxshadow"}
    ...
    ![loadwg](https://static.gl-inet.com/docs/router/de/4/tutorials/surfshark_dedicated_ip/loadwg.jpg){class="glboxshadow"}
    ...
    ![loadovpn](https://static.gl-inet.com/docs/router/de/4/tutorials/surfshark_dedicated_ip/loadovpn.jpg){class="glboxshadow"}
