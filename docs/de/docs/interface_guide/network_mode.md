...
![network mode](https://static.gl-inet.com/docs/router/de/4/interface_guide/network_mode/network_mode_page.png){class="glboxshadow"}
...
![network mode of gl-mt2500](https://static.gl-inet.com/docs/router/de/4/interface_guide/network_mode/network_mode_page_mt2500.png){class="glboxshadow"}
