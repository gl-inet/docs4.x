...
![log in to the GL.iNet Admin Panel](https://static.gl-inet.com/docs/router/en/4/tutorials/how_to_set_up_the_esim_physical_card_with_the_glinet_routers/login-admin-panel.png){class="glboxshadow"}
...
![auto setup](https://static.gl-inet.com/docs/router/en/4/tutorials/how_to_set_up_the_esim_physical_card_with_the_glinet_routers/auto-setup.png){class="glboxshadow"}

If the **Auto Setup** connects to the internet successfully, the screen will appear as shown below:

![auto setup successfully](https://static.gl-inet.com/docs/router/en/4/tutorials/how_to_set_up_the_esim_physical_card_with_the_glinet_routers/auto-setup-successfully.png ){class="glboxshadow"}
...
![auto setup successfully](https://static.gl-inet.com/docs/router/en/4/tutorials/how_to_set_up_the_esim_physical_card_with_the_glinet_routers/latest-firmware.png){class="glboxshadow"}
...
![online upgrade](https://static.gl-inet.com/docs/router/en/4/tutorials/how_to_set_up_the_esim_physical_card_with_the_glinet_routers/online-upgrade.png){class="glboxshadow"}
...
![eSIM manage](https://static.gl-inet.com/docs/router/en/4/tutorials/how_to_set_up_the_esim_physical_card_with_the_glinet_routers/esim-manage-status.png){class="glboxshadow"}
...
![eSIM manage](https://static.gl-inet.com/docs/router/en/4/tutorials/how_to_set_up_the_esim_physical_card_with_the_glinet_routers/esim-management-interface-guide.png){class="glboxshadow"}
...
![eSIM manage](https://static.gl-inet.com/docs/router/en/4/tutorials/how_to_set_up_the_esim_physical_card_with_the_glinet_routers/esim_top-up.png){class="glboxshadow"}
...
![eSIM manage](https://static.gl-inet.com/docs/router/en/4/tutorials/how_to_set_up_the_esim_physical_card_with_the_glinet_routers/esim-manage.png){class="glboxshadow"}
...
![eSIM recommend store](https://static.gl-inet.com/docs/router/en/4/tutorials/how_to_set_up_the_esim_physical_card_with_the_glinet_routers/esim-profile-recommend-store-1.png){class="glboxshadow"}

![eSIM recommend store](https://static.gl-inet.com/docs/router/en/4/tutorials/how_to_set_up_the_esim_physical_card_with_the_glinet_routers/esim-profile-recommend-store-2.png){class="glboxshadow"}
...
![add eSIM profile](https://static.gl-inet.com/docs/router/en/4/tutorials/how_to_set_up_the_esim_physical_card_with_the_glinet_routers/add-esim-profile-1.png){class="glboxshadow"}

![add eSIM profile](https://static.gl-inet.com/docs/router/en/4/tutorials/how_to_set_up_the_esim_physical_card_with_the_glinet_routers/add-esim-profile-2.png){class="glboxshadow"}
...
![enable your new profile](https://static.gl-inet.com/docs/router/en/4/tutorials/how_to_set_up_the_esim_physical_card_with_the_glinet_routers/enable-your-new-profile.png){class="glboxshadow"}
...
![auto setup](https://static.gl-inet.com/docs/router/en/4/tutorials/how_to_set_up_the_esim_physical_card_with_the_glinet_routers/enable-your-new-profile_auto-setup.png){class="glboxshadow"}

Once the eSIM profile is successfully set up, the screen will appear as shown in the screenshot:

![eSIM profile is successfully set up](https://static.gl-inet.com/docs/router/en/4/tutorials/how_to_set_up_the_esim_physical_card_with_the_glinet_routers/enable-your-new-profile-successfully.png){class="glboxshadow"}
...
![eSIM profile is successfully set up](https://static.gl-inet.com/docs/router/en/4/tutorials/how_to_set_up_the_esim_physical_card_with_the_glinet_routers/switch-or-delete-esim-profile.png){class="glboxshadow"}
...
![Unable to Connect to the Internet](https://static.gl-inet.com/docs/router/en/4/tutorials/how_to_set_up_the_esim_physical_card_with_the_glinet_routers/unable-to-connect-to-the-internet.png){class="glboxshadow"}
...
![export log](https://static.gl-inet.com/docs/router/en/4/tutorials/how_to_set_up_the_esim_physical_card_with_the_glinet_routers/unable-to-upload-or-install-your-esim-profile-export-log.png){class="glboxshadow"}

![copy log](https://static.gl-inet.com/docs/router/en/4/tutorials/how_to_set_up_the_esim_physical_card_with_the_glinet_routers/unable-to-upload-or-install-your-esim-profile-export-logo-copy-log.png){class="glboxshadow"}