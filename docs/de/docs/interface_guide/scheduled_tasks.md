...
![LED display schedule](https://static.gl-inet.com/docs/router/de/4/interface_guide/scheduled_tasks/led_display_schedule.png){class="glboxshadow gl-90-desktop"}
...
![LCD display schedule](https://static.gl-inet.com/docs/router/de/4/interface_guide/scheduled_tasks/lcd_display_schedule.png){class="glboxshadow"}
...
![Schedule Reboot](https://static.gl-inet.com/docs/router/de/4/interface_guide/scheduled_tasks/schedule_reboot.png){class="glboxshadow gl-90-desktop"}
...
![MLO Wi-Fi turn on/off](https://static.gl-inet.com/docs/router/de/4/interface_guide/scheduled_tasks/mlo_turn_on_off.png){class="glboxshadow"}
...
![6GHz Wi-Fi turn on/off](https://static.gl-inet.com/docs/router/de/4/interface_guide/scheduled_tasks/6g_turn_on_off.png){class="glboxshadow"}
...
![6GHz Wi-Fi switch TX power](https://static.gl-inet.com/docs/router/de/4/interface_guide/scheduled_tasks/6g_switch_tx_power.png){class="glboxshadow"}
...
![5GHz Wi-Fi turn on/off](https://static.gl-inet.com/docs/router/de/4/interface_guide/scheduled_tasks/5g_turn_on_off.png){class="glboxshadow"}
...
![5GHz Wi-Fi switch TX power](https://static.gl-inet.com/docs/router/de/4/interface_guide/scheduled_tasks/5g_switch_tx_power.png){class="glboxshadow"}
...
![2.4GHz Wi-Fi turn on/off](https://static.gl-inet.com/docs/router/de/4/interface_guide/scheduled_tasks/2.4g_turn_on_off.png){class="glboxshadow"}
...
![2.4GHz Wi-Fi switch TX power](https://static.gl-inet.com/docs/router/de/4/interface_guide/scheduled_tasks/2.4g_switch_tx_power.png){class="glboxshadow"}
