# GL-X3000 (Spitz AX) ユーザーガイド

## ハードウェア情報

GL-X3000（Spitz AX）は、Wi-Fi 6 に対応したセルラーゲートウェイです。遠隔地では安定したセルラーネットワーク接続を、都市部では高速インターネット接続を提供できるよう設計されています。長距離通信向けの 6 本の外部アンテナ、2 枚の SIM カード、WAN ポート、さらに SIM / Ethernet / Repeater 間の Multi-WAN を備えています。
...
Spitz AX の[開封動画](../../video_library/unboxing_first_set_up.md#gl-x3000spitz-ax)もご覧ください。
