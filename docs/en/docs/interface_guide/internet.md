...
**The middle** of the diagram displays the current router model, key features status (e.g., [AdGuard Home](adguardhome.md), [IPv6](ipv6.md), [VPN](vpn_dashboard.md), [Tor](tor.md)), and [wireless](wireless.md) status.  
