...
![join other network](https://static.gl-inet.com/docs/en/4/tutorials/internet_repeater/join_other_network.png){class="glboxshadow gl-90-desktop"}
...
* WPA/WPA2/WPA3 Enterprise, for Extensible Authentication Protocol (EAP), it requires a username and password for authentication.
    ...
    ![join other network, eap](https://static.gl-inet.com/docs/en/4/tutorials/internet_repeater/join_other_network_eap.png){class="glboxshadow gl-90-desktop"}
...
- Warning: *The interface is connected, but the Internet can't be accessed with IPv4 protocol.*
    ...
    ![repeater wrning](https://static.gl-inet.com/docs/en/4/tutorials/internet_repeater/repeater_warning.png){class="glboxshadow gl-90-desktop"}
