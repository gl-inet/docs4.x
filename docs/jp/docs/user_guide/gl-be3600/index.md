...
| 画面表示 | 説明 |
| :--- | :--- |
| ![booting](https://static.gl-inet.com/docs/router/en/4/user_guide/gl-be3600/touchscreen/booting.png) | 起動中 |
| ![network](https://static.gl-inet.com/docs/router/en/4/user_guide/gl-be3600/touchscreen/network.png) | ネットワーク接続タイプと状態<br>**Green**: Active / Connected<br>**Yellow**: Connecting / Abnormal <br>**White**: Inactive connection |
| ![wifi](https://static.gl-inet.com/docs/router/en/4/user_guide/gl-be3600/touchscreen/wifi-details.png) | SSID、パスワード、QRコード、オン/オフボタンを含むWi-Fi情報 |
| ![vpn](https://static.gl-inet.com/docs/router/en/4/user_guide/gl-be3600/touchscreen/vpn_client.png){width="284"} | VPNの状態。Web管理パネルで事前設定が必要です |
...
| ![traffic statistics](https://static.gl-inet.com/docs/router/en/4/user_guide/gl-be3600/touchscreen/traffic_statistics.png) | トラフィック統計<br>ルーターを通過する全トラフィックの平均速度を3秒ごとに計算して表示します |
| ![system usage](https://static.gl-inet.com/docs/router/en/4/user_guide/gl-be3600/touchscreen/overview.png) | システム使用状況 |
| ![time zone](https://static.gl-inet.com/docs/router/en/4/user_guide/gl-be3600/touchscreen/time.png) | タイムゾーン |
| ![system menu](https://static.gl-inet.com/docs/router/en/4/user_guide/gl-be3600/touchscreen/system_settings.png) | システムメニュー<br>上から下にスワイプするとシステムメニューにアクセスできます |
| ![unlock](https://static.gl-inet.com/docs/router/en/4/user_guide/gl-be3600/touchscreen/slide-to-unlock.png) | 画面をタップして点灯し、左から右へスライドしてロックを解除します |
| ![reboot](https://static.gl-inet.com/docs/router/en/4/user_guide/gl-be3600/touchscreen/slide-to-reboot.png) | 「Reboot」をクリックした後、左から右へスライドして確認します |
