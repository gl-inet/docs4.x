...
![enable tor](https://static.gl-inet.com/docs/router/de/4/interface_guide/tor/enable_tor.png){class="glboxshadow"}

Der Verbindungsaufbau startet anschließend. Wenn Ihr Netzwerk die Anforderungen erfüllt, wird „connected“ angezeigt.

![tor connected](https://static.gl-inet.com/docs/router/de/4/interface_guide/tor/connected.png){class="glboxshadow" width="672"}
...
![torview](https://static.gl-inet.com/docs/router/de/4/interface_guide/tor/torview.jpg){class="glboxshadow"}

![torpage](https://static.gl-inet.com/docs/router/de/4/interface_guide/tor/torpage.jpg){class="glboxshadow"}
