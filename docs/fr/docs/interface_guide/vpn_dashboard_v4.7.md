...
![tableau de bord VPN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpn_dashboard_initial.png){class="glboxshadow"}
...
![configuration du client VPN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnclient_setup.png){class="glboxshadow"}
...
![fichiers de configuration VPN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnclient_config.png){class="glboxshadow"}

### Options du client

Cliquez sur l'icône d'engrenage à droite pour accéder aux options du client OpenVPN ou WireGuard.

![options du client VPN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnclient_options.png){class="glboxshadow"}

Les options du client OpenVPN s'affichent comme suit.

![options du client OpenVPN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnclient_options_ovpn.png){class="glboxshadow"}

Les options du client WireGuard s'affichent comme suit.

![options du client WireGuard](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnclient_options_wg.png){class="glboxshadow"}
...
- **Remote Access LAN** : si cette option est activée, l'accès à distance à ce routeur et à ses appareils LAN via le VPN sera autorisé. Le serveur VPN doit annoncer une route vers le sous-réseau LAN de ce routeur.
    ...
    ![accès à distance au LAN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/allow_remote_access_lan_diagram.png){class="glboxshadow gl-80-desktop"}
...
![mode proxy VPN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnclient_proxy.png){class="glboxshadow"}
...
![options globales du client VPN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnclient_global_options_1.png){class="glboxshadow"}

![options globales](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnclient_global_options_2.png){class="glboxshadow"}
...
- **Allow Access WAN** : si cette option est activée, les appareils clients locaux peuvent toujours accéder aux services côté WAN (par ex. imprimantes, NAS et autres appareils du sous-réseau amont) pendant que le VPN est actif.
    ...
    ![autoriser l'accès au WAN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/allow_access_wan_diagram.jpg){class="glboxshadow gl-90-desktop"}
...
![configuration du serveur VPN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnserver_setup.png){class="glboxshadow"}

Après l'activation du serveur OpenVPN ou WireGuard, la page affichera l'état du serveur comme suit.

![serveur VPN activé](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnserver_connected.png){class="glboxshadow"}

### Options du serveur

Cliquez sur l'icône d'engrenage à droite pour accéder aux options du serveur OpenVPN ou WireGuard.

![options du serveur VPN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnserver_options.png){class="glboxshadow"}

Les options du serveur OpenVPN s'affichent comme suit.

![options du serveur OpenVPN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnserver_options_ovpn.png){class="glboxshadow"}

Les options du serveur WireGuard s'affichent comme suit.

![options du serveur WireGuard](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnserver_options_wg.png){class="glboxshadow"}
...
![règles de routage du serveur VPN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnserver_route_rule.png){class="glboxshadow"}
...
![règles de routage du serveur OpenVPN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnserver_route_rule_ovpn.png){class="glboxshadow"}
...
![règles de routage du serveur WireGuard](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnserver_route_rule_wg.png){class="glboxshadow"}
...
![options globales du serveur VPN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnserver_global_options_1.png){class="glboxshadow"}

![options globales du serveur VPN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnserver_global_options_2.png){class="glboxshadow"}
