...
En el lado izquierdo del panel de administración web, vaya a **SYSTEM** -> **Time Zone**.

El router registra las marcas de tiempo de la actividad según la hora de su sistema, y algunas funciones dependen de que la hora sea correcta para funcionar adecuadamente. Asegúrese de haber seleccionado y sincronizado la zona horaria correcta.
