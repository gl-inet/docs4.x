...
アクティベーションが完たするまでに最大24時間かかる場合があります。アクティベーションが成功すると、確認メールが届き、SIMカードの使用を開始できます。アクティベート後、SIMカードは30日間有効です。その後、SIMカードを使用し続けるにはトップアップする必要があります。
