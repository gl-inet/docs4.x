...
1. Besuchen Sie die [offizielle ZeroTier-Website](https://www.zerotier.com/){target="_blank"} und melden Sie sich mit Ihrem Konto an.
    ...
    ![create organization](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/new_central/zerotier_login.jpg){class="glboxshadow"}

2. Erstellen Sie eine Organisation.

    ![create organization](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/new_central/create_org.png){class="glboxshadow"}
...
3. Wählen Sie einen Tarif aus. Hier verwenden wir als Beispiel den Personal-Plan, der 10 Geräte, 1 Netzwerkadministrator und 1 Netzwerk umfasst. Wenn Sie mehr Netzwerke erstellen, zusätzliche Geräte hinzufügen oder benutzerdefinierte Routen und DNS hinzufügen müssen, wählen Sie den Essential- oder Scale-Plan.
    ...
    ![select plan](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/new_central/select_plan.png){class="glboxshadow"}
...
4. Jetzt wurde Ihr ZeroTier-Netzwerk erstellt. Notieren Sie sich die **Network ID**, eine 16-stellige alphanumerische Kombination oben rechts, da sie später benötigt wird, wenn Sie weitere Geräte verbinden.
    ...
    ![network id](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/new_central/zt_network_id.png){class="glboxshadow"}
...
5. Aktivieren Sie ZeroTier auf dem GL.iNet-Router.
    ...
    ![enable zerotier](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/new_central/enable_zerotier.png){class="glboxshadow"}
    ...
    ![authorize 1](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/new_central/authorize1.png){class="glboxshadow"}
...
6. Autorisieren Sie Ihr Gerät in ZeroTier Central.
    ...
    ![authorize 2](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/new_central/authorize2.png){class="glboxshadow"}

    Nach der Autorisierung wird die Seite wie folgt angezeigt.

    ![authorized 1](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/new_central/authorized1.png){class="glboxshadow"}
...
7. Fügen Sie ein weiteres Gerät (z. B. einen Computer oder ein Smartphone) demselben ZeroTier-Netzwerk hinzu, indem Sie [dieser Anleitung](https://docs.zerotier.com/platforms/){target="_blank"} folgen.
    ...
    3. Klicken Sie mit der rechten Maustaste auf das Symbol, wählen Sie **Join New Network** und geben Sie im Pop-up-Fenster die **Network ID** ein, die Sie in Schritt 4 erhalten haben.
        ...
        ![laptop join network](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/new_central/laptop_join_network.png){class="glboxshadow"}

        Wechseln Sie anschließend zu ZeroTier Central, suchen Sie das ausstehende Gerät und autorisieren Sie es.

        ![authorize 3](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/new_central/authorize3.png){class="glboxshadow"}
    ...
    4. Nach der Autorisierung wird die Seite wie folgt angezeigt. Sie sehen die Details der Mitgliedsgeräte, z. B. **Device ID**, **Name**, **Status**, **Managed IP** und **Public IP**.
        ...
        ![authorized 2](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/new_central/authorized2.png){class="glboxshadow"}
...
8. Klicken Sie auf die **Managed IP** des Routers, um sie zu kopieren. Anschließend können Sie diese Managed IP verwenden, um von Ihrem Laptop aus auf den Router zuzugreifen, der sich im selben ZeroTier-Netzwerk befindet.
    ...
    ![zerotier virtual ip](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/new_central/zerotier_virtual_ip.png){class="glboxshadow"}
...
9. Testen Sie die Konnektivität.
    ...
    ![web admin panel](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/new_central/connectivity_test1.png){class="glboxshadow"}
    ...
    ![ping test](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/new_central/connectivity_test2.png){class="glboxshadow"}
...
1. Erstellen Sie Ihr erstes ZeroTier-Netzwerk.
    ...
    ![zerotier network id](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/zerotier_network_id.png){class="glboxshadow"}
...
2. Aktivieren Sie ZeroTier auf dem GL.iNet-Router.
    ...
    ![enable zerotier](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/zerotier_enable.png){class="glboxshadow"}
    ...
    ![zerotier central](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/zerotier_central.png){class="glboxshadow"}
...
3. Autorisieren Sie Ihr Gerät in ZeroTier Central.
    ...
    ![zerotier members, auth](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/zerotier_members_auth.png){class="glboxshadow"}
    ...
    ![zerotier managed ip](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/managed_ip.png){class="glboxshadow"}
...
5. Testen Sie die Konnektivität.
    ...
    ![web admin panel](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/web_admin_panel.png)
...
![remote access wan topology](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/zerotier_access_wan_topology.png){class="glboxshadow"}
...
1. Melden Sie sich in der Web-Adminoberfläche Ihres Routers an und navigieren Sie zu **APPLICATIONS** -> **ZeroTier**.
    ...
    ![enable allow remote access wan](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/enable_allow_remote_access_wan_1.png){class="glboxshadow"}
    ...
    ![enable allow remote access wan](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/enable_allow_remote_access_wan_2.png){class="glboxshadow"}
...
2. Gehen Sie zu **ZeroTier Central** und suchen Sie den Abschnitt **Advanced**.
    ...
    ![add route](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/add_routes_1.png){class="glboxshadow"}

    Nach dem Hinzufügen der Route wird der Abschnitt **Managed Routes** wie unten gezeigt angezeigt.

    ![add route](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/add_routes_2.png){class="glboxshadow"}
...
3. Sie können nun auf anderen Geräten über seine IP-Adresse (`192.168.29.1`) auf den `GL-AXT1800` zugreifen. Tatsächlich können Sie auf alle Geräte innerhalb des Subnetzes `192.168.29.0/24` zugreifen.
    ...
    ![access axt1800](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/zerotier_access_axt1800.jpg){class="glboxshadow gl-50-desktop"}
...
![remote access lan topology](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/zerotier_access_lan_topology.png){class="glboxshadow"}
...
1. Melden Sie sich in der Web-Adminoberfläche Ihres Routers an und navigieren Sie zu **APPLICATIONS** -> **ZeroTier**.
    ...
    ![enable allow remote access lan](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/enable_allow_remote_access_lan_1.png){class="glboxshadow"}

    Es erscheint eine Aufforderung, Routing-Regeln zu konfigurieren. Lassen Sie diese Webseite geöffnet oder notieren Sie sich die Routendetails (Destination und Via), da diese im nächsten Schritt benötigt werden.

    ![enable allow remote access lan](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/enable_allow_remote_access_lan_2.png){class="glboxshadow"}

2. Gehen Sie zu **ZeroTier Central** und suchen Sie den Abschnitt **Advanced**.

    Geben Sie die Routendetails (Destination und Via) aus dem vorherigen Schritt ein und klicken Sie dann auf **Submit**.

    ![add route](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/add_routes_3.png){class="glboxshadow"}

    Nach dem Hinzufügen der Route wird der Abschnitt **Managed Routes** wie unten gezeigt angezeigt.

    ![add route](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/add_routes_4.png){class="glboxshadow"}
...
3. Sie können nun auf anderen Geräten per `ping` oder SSH über die IP-Adresse (`192.168.8.110`) auf `Ubuntu` zugreifen. Tatsächlich können Sie auf alle Geräte innerhalb des Subnetzes `192.168.8.0/24` zugreifen.
    ...
    ![access ubuntu](https://static.gl-inet.com/docs/router/de/4/interface_guide/zerotier/zerotier_access_ubuntu.jpg){class="glboxshadow gl-80-desktop"}
