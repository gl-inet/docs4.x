...
3. Vuelva a la página de su cuenta de Nord, vaya a **Manual Setup** y haga clic en **Set up NordVPN Manually** para obtener sus **service credentials**.
...
4. Inicie sesión en el panel de administración web de su router y vaya a **VPN** > **OpenVPN Client**. Cree un nuevo grupo y cargue el archivo de configuración descargado en el paso 2; a continuación, introduzca las **service credentials** obtenidas en el paso 3.
    ...
    Como se muestra arriba, se ha detectado un archivo de configuración válido. Introduzca sus **service credentials** de NordVPN.
