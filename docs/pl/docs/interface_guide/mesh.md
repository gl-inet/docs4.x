...
Mango 2 (GL-MG1300) i Mudi 7 (GL-E5800) nie obsługują Mesh nawet z firmware v4.10 lub nowszym. Szczegółowe informacje znajdują się w sekcji [Obsługiwane modele](#supported-models).
