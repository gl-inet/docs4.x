...
Flint（GL-AX1800）は、最大600Mbps（2.4GHz）+ 1200Mbps（5GHz）の接続速度を持つデュアルバンドWi-Fi 6ルーターです。VPN暗号化速度は最大667Mbpsまで向上し、VPNサーバーのホストに使用することができます。Flintは、大容量のデータ転送や大量のデバイス接続、または超低遅延のゲームなどに最適です。
