...
Beryl(GL-MT1300)は高パフォーマンスな次世代ポケットサイズのルーターで、パワフルなハードウェアと一ストリームのサイバーセキュリティプロトコルをユニークでモダンなデザインで提供します。Berylは新時代の旅行用ルーターであり、当社のベストセラーであるSlate (GL-AR750S)の進化版です。
