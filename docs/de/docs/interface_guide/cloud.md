...
1. GoodCloud aktivieren.
    ...
    ![enable goodcloud](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/enable_goodcloud_1.png){class="glboxshadow"}
    ...
    ![enable goodcloud](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/enable_goodcloud_2.png){class="glboxshadow"}
...
3. Geräte hinzufügen.
    ...
    ![add device](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/add_devices_1.png){class="glboxshadow"}
    ...
    ??? "Auto Discover"
        ...
        ![add device, auto discover](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/add_devices_auto.jpg){class="glboxshadow"}
    ...
    ??? "Manually Add"
        ...
        ![manually add device](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/add_devices_manual.jpg){class="glboxshadow"}
    ...
    ??? "Bulk Import"
        ...
        **Bulk Import** ist für Benutzer gedacht, die eine große Anzahl von Geräten verwalten. Sie können mehrere Geräte über eine Microsoft-Excel-Datei importieren.
        ...
        ![bulk import](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/add_devices_bulk.jpg){class="glboxshadow"}

4. Details zur Verknüpfung.
...
![devices info](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/devices_info.png){class="glboxshadow"}
...
![device actions1](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/device_actions1.png){class="glboxshadow"}

![device actions2](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/device_actions2.jpg){class="glboxshadow"}
...
![column display](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/column_display.png){class="glboxshadow"}
...
![Device detail info](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/device_details.png){class="glboxshadow"}

#### Basisinformationen

![basic info](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/basic_info.png){class="glboxshadow"}

#### Statistiken

![statistics](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/statistics.png){class="glboxshadow"}

#### Netzwerkeinstellungen

Auf dieser Seite werden die Netzwerkkonfigurationen und Wi-Fi-Einstellungen Ihres Routers angezeigt.

![status overview](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/device_overview.png){class="glboxshadow"}

#### Client-Liste

![clients list](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/clients_list.png){class="glboxshadow"}
...
![remote access](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/remote_access.png){class="glboxshadow"}

### Remote GUI

Klicken Sie auf **Remote GUI**, um remote auf das webbasierte Admin Panel Ihres Routers zuzugreifen.

![remote access web admin panel](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/remote_web_admin_panel.png){class="glboxshadow"}
...
![remote access device terminal](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/remote_terminal.png){class="glboxshadow"}
...
![device settings 1](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/modify_settings_1.png){class="glboxshadow"}
...
![device settings 2](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/modify_settings_2.png){class="glboxshadow"}
...
![notifications 1](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/notifications1.png){class="glboxshadow"}

Wählen Sie das Gerät aus, das Sie überwachen möchten, und klicken Sie auf **Next**.

![notifications 2](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/notifications2.png){class="glboxshadow"}

Wählen Sie das auslösende Ereignis, z. B. den Online-/Offline-Status des Geräts, und klicken Sie auf **Next**.

![notifications 3](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/notifications3.png){class="glboxshadow"}

![notifications 4](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/notifications4.png){class="glboxshadow"}

Prüfen Sie die Regeleinstellungen und klicken Sie auf **Apply**.

![notifications 5](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/notifications5.png){class="glboxshadow"}
...
![notifications 6](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/notifications6.png){class="glboxshadow"}
...
![Services from GL.iNet use VPN](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/goodcloud_vpn.png){class="glboxshadow"}
...
![View Logs](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/view_logs.png){class="glboxshadow"}
...
??? "Für Firmware v4.6 oder älter"
    ...
    ![disable cloud 1](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/disable_cloud_1.jpg){class="glboxshadow"}

    Nach der Deaktivierung wird die Oberfläche wie folgt angezeigt.

    ![disabled cloud 1](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/disabled_cloud.png){class="glboxshadow"}
...
??? "Für Firmware v4.7 oder neuer"
    ...
    ![disable cloud 2](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/disable_cloud_2.png){class="glboxshadow"}

    Nach der Deaktivierung wird die Oberfläche wie folgt angezeigt.

    ![disabled cloud 2](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/disabled_cloud_2.png){class="glboxshadow"}
...
![delete account](https://static.gl-inet.com/docs/router/de/4/interface_guide/cloud/delete_account.png){class="glboxshadow"}
