...
![vpn dashboard](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpn_dashboard_initial.png){class="glboxshadow"}
...
![konfiguracja klienta VPN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnclient_setup.png){class="glboxshadow"}
...
![pliki konfiguracyjne](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnclient_config.png){class="glboxshadow"}

### Opcje klienta

Kliknij ikonę koła zębatego po prawej stronie, aby uzyskać dostęp do opcji klienta OpenVPN lub WireGuard.

![opcje klienta VPN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnclient_options.png){class="glboxshadow"}

Opcje klienta OpenVPN są wyświetlane jak poniżej.

![opcje klienta OpenVPN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnclient_options_ovpn.png){class="glboxshadow"}

Opcje klienta WireGuard są wyświetlane jak poniżej.

![opcje klienta WireGuard](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnclient_options_wg.png){class="glboxshadow"}
...
- **Zdalny dostęp do LAN**: Jeśli ta opcja jest włączona, zdalny dostęp do tego routera i jego urządzeń LAN przez VPN będzie dozwolony. Serwer VPN musi rozgłaszać trasę do podsieci LAN tego routera.
    ...
    ![zezwól na zdalny dostęp do LAN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/allow_remote_access_lan_diagram.png){class="glboxshadow gl-80-desktop"}
...
![tryb proxy VPN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnclient_proxy.png){class="glboxshadow"}
...
![opcje globalne klienta VPN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnclient_global_options_1.png){class="glboxshadow"}

![opcje globalne](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnclient_global_options_2.png){class="glboxshadow"}
...
- **Allow Access WAN**: Jeśli ta opcja jest włączona, lokalne urządzenia klienckie nadal mogą uzyskiwać dostęp do usług po stronie WAN (np. drukarek, NAS i innych urządzeń w podsieci nadrzędnej), gdy VPN jest aktywny.
    ...
    ![zezwól na dostęp do WAN klienta VPN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/allow_access_wan_diagram.jpg){class="glboxshadow gl-90-desktop"}
...
![konfiguracja serwera VPN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnserver_setup.png){class="glboxshadow"}

Po włączeniu serwera OpenVPN lub WireGuard strona wyświetli stan serwera jak poniżej.

![serwer VPN włączony](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnserver_connected.png){class="glboxshadow"}

### Opcje serwera

Kliknij ikonę koła zębatego po prawej stronie, aby uzyskać dostęp do opcji serwera OpenVPN lub WireGuard.

![opcje serwera VPN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnserver_options.png){class="glboxshadow"}

Opcje serwera OpenVPN są wyświetlane jak poniżej.

![opcje serwera OpenVPN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnserver_options_ovpn.png){class="glboxshadow"}

Opcje serwera WireGuard są wyświetlane jak poniżej.

![opcje serwera WireGuard](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnserver_options_wg.png){class="glboxshadow"}
...
![reguła trasy serwera](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnserver_route_rule.png){class="glboxshadow"}
...
![reguła trasy serwera OpenVPN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnserver_route_rule_ovpn.png){class="glboxshadow"}
...
![reguła trasy serwera WireGuard](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnserver_route_rule_wg.png){class="glboxshadow"}
...
![globalne opcje serwera VPN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnserver_global_options_1.png){class="glboxshadow"}

![globalne opcje serwera VPN](https://static.gl-inet.com/docs/router/en/4/interface_guide/vpn_dashboard_v4.7/vpnserver_global_options_2.png){class="glboxshadow"}
