# GL-XE3000 (Puli AX) ユーザーガイド

## ハードウェア情報

Puli AX（GL-XE3000）は、Wi-Fi 6 と 5G に対応したセルラールーターです。6400mAh / 7.4V / 47.4Wh の大容量バッテリーを内蔵し、長時間のインターネット接続に対応します。最大 574Mbps（2.4GHz）+ 2402Mbps（5GHz）、合計最大 3000Mbps の Wi-Fi 速度を提供し、5G NR 接続により Ethernet 回線に障害が発生した場合でも接続を維持しやすくなっています。

デュアルSIM・シングルスタンバイに対応しており、2枚のSIMカードを装着できますが、同時に有効化できるのは1枚のみです。必要に応じて切り替えて使用できます。
...
![Ethernet Connection](https://static.gl-inet.com/docs/router/en/4/user_guide/gl-xe3000/internet/xe3000_ethernet.png){class="glboxshadow"}

### リピーター

ルーターで既存の Wi-Fi 信号を受信し、その信号を再送信することで、Wi-Fi のカバー範囲を拡張します。1 台のルーターだけでは利用エリア全体を十分にカバーできない場合に特に有効です。

[既存の Wi-Fi 経由でインターネットに接続する方法については、ここをクリックしてください。](../../interface_guide/internet_repeater.md)

![Repeater Connection](https://static.gl-inet.com/docs/router/en/4/user_guide/gl-xe3000/internet/xe3000_repeater.png){class="glboxshadow"}
...
![Tethering Connection](https://static.gl-inet.com/docs/router/en/4/user_guide/gl-xe3000/internet/xe3000_tethering.png){class="glboxshadow"}

### セルラー
 
セルラー対応の USB モデムをルーターの USB ポートに挿入してインターネットに接続します。USB モデムの回線を接続中のすべてのデバイスで共有したい場合に便利です。

デュアルSIM・シングルスタンバイに対応しており、2枚のSIMカードを装着できますが、同時に有効化できるのは1枚のみです。必要に応じて切り替えて使用できます。

[USBモデム経由でインターネットに接続する方法については、ここをクリックしてください。](../../interface_guide/internet_cellular.md)

![Cellular Connection](https://static.gl-inet.com/docs/router/en/4/user_guide/gl-xe3000/internet/xe3000_celluar.png){class="glboxshadow"}
...
- [**VPN ダッシュボード**](../../interface_guide/vpn_dashboard_v4.8.md)
...
以前は[ハードウェアアクセラレーション](../../interface_guide/hardware_acceleration.md)と呼ばれていました。
