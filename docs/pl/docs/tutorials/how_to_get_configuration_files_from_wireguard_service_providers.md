...
??? "PrivadoVPN"
    ...
    Na pulpicie znajdź sekcję Manual Configuration i kliknij WireGuard. Wybierz serwer, z którym chcesz się połączyć, a następnie kliknij Download Configuration.
...
??? "PureVPN"
    ...
    4. Wybierz **Linux** jako typ urządzenia, a następnie kliknij **Generate Configuration**. Plik konfiguracyjny zostanie pobrany na urządzenie lokalne.
        ...
        **Uwaga**: Konfiguracja WireGuard wygasa po 30 minutach. Aktywuj połączenie w okresie ważności. W przeciwnym razie trzeba wygenerować nową.
