...
**注意:** ベータ版ファームウェアにはバグがある可能性があります。現にのところ、アップグレード時に設定が失われたり、不安定になったりする可能性があるため、アップグレード時に設定を保持しないことをお勧めします。そのため、アップグレード前に重要な設定をバックアップしておいてください。よりスムーズなアップグレードができるよう、プロセスを改善していきます。

**注意:** 現に、GL-B1300とGL-S1300にはメッシュ機能はありません。
