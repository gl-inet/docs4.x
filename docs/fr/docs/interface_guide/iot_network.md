...
**Note**: Certains modèles (par exemple GL-MT5000, GL-MT2500/GL-MT2500A) ne disposent pas de fonctionnalité Wi‑Fi ; les paramètres **IoT Network** ne sont donc pas disponibles dans leur panneau d'administration web.
...
- **Gateway**
    ...
    La **passerelle par défaut** du réseau IoT est **192.168.10.1**. Si elle entre en conflit avec votre réseau local, remplacez-la par une autre adresse.
...
- **Gateway** : appareil qui route le trafic entre le réseau IoT et les réseaux externes, tels qu'Internet.
