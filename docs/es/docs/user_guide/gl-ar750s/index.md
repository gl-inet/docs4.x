# Guía de usuario de Slate (GL-AR750S)

## Descripción general del producto

Slate (GL-AR750S) es nuestro primer router de viaje Gigabit AC de doble banda. Con 3 puertos Ethernet Gigabit, puede ofrecer mayor velocidad durante sus viajes. Además, la memoria Flash de 128 MB proporciona doble flash para más almacenamiento y un funcionamiento más rápido. Incluye una ranura MicroSD (TF) que amplía el almacenamiento hasta 128 GB.
...
Vea el [video de unboxing](../../video_library/unboxing_first_set_up.md#slategl-ar750s-ext) de Slate.
