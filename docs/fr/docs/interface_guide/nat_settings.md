...
Dans la partie gauche du panneau d'administration web, accédez à **NETWORK** -> **NAT Settings**, ou à **SECURITY** -> **NAT Mode** (pour le firmware v4.9 et les versions ultérieures).
