...
![security_access_control](https://static.gl-inet.com/docs/router/de/4/interface_guide/admin_access/access_control_4.8.png){class="glboxshadow"}
...
![http_https_port_forbidden](https://static.gl-inet.com/docs/router/de/4/interface_guide/admin_access/http_https_port_forbidden.png){class="glboxshadow"}
...
![security_remote_access_control](https://static.gl-inet.com/docs/router/de/4/interface_guide/admin_access/security_remote_access_control.png){class="glboxshadow"}
...
![add_ip_address_1](https://static.gl-inet.com/docs/router/de/4/interface_guide/admin_access/add_ip_address_1.png){class="glboxshadow"}

![add_ip_address_2](https://static.gl-inet.com/docs/router/de/4/interface_guide/admin_access/add_ip_address_2.png){class="glboxshadow"}
...
![open Ports on router](https://static.gl-inet.com/docs/router/de/4/interface_guide/admin_access/open_ports_on_router.png){class="glboxshadow"}

![open Ports on router](https://static.gl-inet.com/docs/router/de/4/interface_guide/admin_access/add_new_open_port.png){class="glboxshadow"}
