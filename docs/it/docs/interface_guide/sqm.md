...
**Nota**: questa funzionalità è stata introdotta nel firmware v4.9. Alcuni modelli, come Mango 2 (GL-MG1300), non supportano SQM a causa di memoria insufficiente, anche quando si esegue il firmware v4.9 o successivo.
