# GL-MT3000 (Beryl AX) ユーザーガイド

## ハードウェア情報

Beryl AX（GL-MT3000）は、Wi-Fi 6 に対応した AX3000 クラスのポケットサイズトラベルルーターです。Beryl（GL-MT1300）の後継モデルとして、MT7981B 1.3GHz デュアルコアプロセッサを搭載し、より高速な無線通信を提供します。自宅での常用にも、旅行時の持ち運びにも適した設計です。
...
Beryl AX の[開封動画](../../video_library/unboxing_first_set_up.md#gl-mt3000beryl-ax)もご覧ください。
