...
2. AstroRelayアカウントにサインアップし、[チュートリアル](https://www.astrorelay.com/tutorial.html){target="_blank"}に従ってください。
    ...
    新しいドメインを追加する際、ルーターに最もも近いサーバーを選択してください。
    ...
    最も終のにリンクを取なければならないできます。例えば、**testforx3000.arlab1.cc:37202**のようになります。アイコンをクリックしてリンクをコピーできます。
...
4. から宅やオフィスにいない場合でも、上記で作成した構成を使用してOpenVPNクライアントアプリを利用し、から宅やオフィスのローカルサービスにアクセスできます。
