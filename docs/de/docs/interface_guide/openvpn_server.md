...
2. Übernehmen Sie die Konfiguration.
    ...
    ![openvpn server configuration](https://static.gl-inet.com/docs/router/de/4/interface_guide/openvpn_server/ovpnserver_configuration.png){class="glboxshadow"}
    ...
    * **Authentication Mode:** Hiermit wird festgelegt, welche Authentifizierungsmethode verwendet wird, wenn sich der Client mit dem Server verbindet. Es gibt drei Optionen.
        ...
        ![openvpn server add a user](https://static.gl-inet.com/docs/router/de/4/interface_guide/openvpn_server/ovpnserver_add_a_user.png){class="glboxshadow"}

    * **Advanced Configuration**: Bei Bedarf können Sie weitere Servereinstellungen anpassen.
    
        ![openvpn server advancd configuration](https://static.gl-inet.com/docs/router/de/4/interface_guide/openvpn_server/ovpnserver_advanced_config.png){class="glboxshadow"}
...
3. Client-Konfiguration exportieren.
    ...
    ![openvpn export config](https://static.gl-inet.com/docs/router/de/4/interface_guide/openvpn_server/ovpnserver_export_config.png){class="glboxshadow"}
...
4. OpenVPN-Server starten.
    ...
    ![start openvpn server](https://static.gl-inet.com/docs/router/de/4/interface_guide/openvpn_server/start_ovpnserver.png){class="glboxshadow"}
...
![openvpn server connected v4.8](https://static.gl-inet.com/docs/router/de/4/interface_guide/openvpn_server/ovpnserver_status.jpg){class="glboxshadow"}

Bei Firmware v4.7 und früher prüfen Sie den Verbindungsstatus des Servers bitte auf der Seite **VPN Dashboard**.

![openvpn server connected v4.7](https://static.gl-inet.com/docs/router/de/4/interface_guide/openvpn_server/openserverup.jpg){class="glboxshadow"}
...
![openvpn app select certificate](https://static.gl-inet.com/docs/router/de/4/interface_guide/openvpn_server/select_certificate.png){class="glboxshadow" width="360"}
...
Navigieren Sie bei Firmware v4.8 und höher zu **OpenVPN Server** und klicken Sie oben rechts auf **Options**.
...
Navigieren Sie bei Firmware v4.7 und älter zu **VPN Dashboard** -> **VPN Server** und klicken Sie auf das Zahnradsymbol, um die OpenVPN Options aufzurufen.
...
Client to Client ist eine serverseitige VPN-Funktion. Nach der Aktivierung können verbundene VPN-Clients über ihre jeweiligen VPN-Tunnel-IPs miteinander kommunizieren.
...
Führen Sie bei Bedarf die folgenden Schritte aus, um Client to Client auf Ihrem OpenVPN-Server zu aktivieren.

1. Klicken Sie auf der Seite **OpenVPN Server** unten rechts auf **Advanced Configuration**.
...
2. Aktivieren Sie **Client to Client** und klicken Sie auf **Apply**. Exportieren Sie anschließend eine neue Konfiguration und laden Sie sie auf Ihre OpenVPN-Clients hoch.
