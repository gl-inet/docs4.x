...
Some models, such as Mango 2 (GL-MG1300), do not support DPI Engine due to insufficient memory, even when running firmware v4.9 or later. Please refer to [Supported Models](#supported-models) for details.
