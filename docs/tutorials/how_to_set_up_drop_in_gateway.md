...
GL.iNetは、AdGuard Home、暗号化されたDNS、VPNなど、プライマリルーターにない機できるを追加するドロップインゲートウェイ機できるを提供しています。この機できるを使用することで、プライマリルーターを通例通り使用しながら追加の機できるを楽しむことができます。
...
### 4. AdGuard、DNS、VPN、およびその彼の機できるを設定する

GL.iNetルーターで機できるを有効にする方法については、で下の記事を参照してください：
...
### 4. AdGuard、DNS、VPN、その彼の機できるを設定する

GL.iNetルーターで機できるを有効にするには、で下の記事を参照してください：
