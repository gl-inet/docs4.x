# Guida utente di GL-S200

## Panoramica del prodotto

GL-S200 è un gateway Thread miniaturizzato con supporto al protocollo BLE, basato sul sistema operativo OpenWrt altamente personalizzabile e con supporto alla gestione cloud dei dispositivi. Ha un design versatile per il collegamento a diversi dispositivi smart home o per la connettività di massa in edifici intelligenti.
...
Guarda il [video di unboxing](../../video_library/unboxing_first_set_up.md#gl-s200) di GL-S200.

## Specifiche

[Specifiche di GL-S200](https://www.gl-inet.com/products/gl-s200/#specs){target="_blank"}
...
## Piedinatura GL Thread Dev Board
...
Per GL-S200 sono supportati due tipi di connessione: Ethernet e Repeater.
...
Fai riferimento a [Thread Mesh](https://docs.gl-inet.com/iot/en/thread_board_router/gl-s200/thread_mesh/){target="_blank"} nella documentazione IoT.

---

## GL Dev Board

Fai riferimento a [GL Dev Board](https://docs.gl-inet.com/iot/en/iot_dev_board/){target="_blank"} nella documentazione IoT.

---

## Bluetooth

Fai riferimento a [Bluetooth](https://docs.gl-inet.com/iot/en/thread_board_router/gl-s200/bluetooth/){target="_blank"} nella documentazione IoT.
