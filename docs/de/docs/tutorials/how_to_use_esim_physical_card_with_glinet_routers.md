...
![eSIM Physical Card](https://static.gl-inet.com/docs/router/de/4/tutorials/how_to_set_up_the_esim/simpoyo-esim-physical-card.png){class="glboxshadow"}
...
![E750V2](https://static.gl-inet.com/docs/router/de/4/tutorials/how_to_set_up_the_esim/e750v2-sim-card.jpg){class="glboxshadow"}

![X3000](https://static.gl-inet.com/docs/router/de/4/tutorials/how_to_set_up_the_esim/x3000-sim-card.jpg){class="glboxshadow"}

![XE3000](https://static.gl-inet.com/docs/router/de/4/tutorials/how_to_set_up_the_esim/xe3000-sim-card.jpg){class="glboxshadow"}
...
![log in to the GL.iNet Admin Panel](https://static.gl-inet.com/docs/router/de/4/tutorials/how_to_set_up_the_esim/login-admin-panel.jpg){class="glboxshadow"}
...
![initial setup connect](https://static.gl-inet.com/docs/router/de/4/tutorials/how_to_set_up_the_esim/initial-setup-connect.jpg){class="glboxshadow"}

Wenn die Internetverbindung erfolgreich hergestellt wurde, sieht der Bildschirm wie folgt aus.

![initial setup connected](https://static.gl-inet.com/docs/router/de/4/tutorials/how_to_set_up_the_esim/initial-setup-connected.jpg){class="glboxshadow"}
...
![auto setup successfully](https://static.gl-inet.com/docs/router/de/4/tutorials/how_to_set_up_the_esim/latest-firmware.png){class="glboxshadow"}
...
2. Gehen Sie im Web-Admin-Panel zu **SYSTEM** > **Upgrade** > **Online Upgrade** und klicken Sie auf die Schaltfläche **Install**, um automatisch auf die neueste Firmware zu aktualisieren.
    ...
    ![online upgrade](https://static.gl-inet.com/docs/router/de/4/tutorials/how_to_set_up_the_esim/online-upgrade.png){class="glboxshadow"}
...
2. Gehen Sie im Web-Admin-Panel zu **SYSTEM** > **Upgrade** > **Local Upgrade**. Wählen Sie die Firmware-Datei aus oder ziehen Sie sie in den vorgesehenen Bereich, um auf die neueste Version zu aktualisieren.
    ...
    ![local upgrade](https://static.gl-inet.com/docs/router/de/4/tutorials/how_to_set_up_the_esim/local-upgrade.png){class="glboxshadow"}
...
![eSIM manage](https://static.gl-inet.com/docs/router/de/4/tutorials/how_to_set_up_the_esim/esim-manage-status.jpg){class="glboxshadow"}
