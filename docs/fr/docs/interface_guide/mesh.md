...
Mango 2 (GL-MG1300) et Mudi 7 (GL-E5800) ne prennent pas en charge Mesh, même avec le firmware v4.10 ou une version ultérieure. Consultez les [modèles pris en charge](#supported-models) pour plus de détails.
