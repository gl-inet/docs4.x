...
Beryl（GL-MT1300）は、高性能ハードウェアと最新のセキュリティ機能を備えた次世代のポケットサイズルーターです。モダンなデザインを採用し、人気モデル Slate（GL-AR750S）の後継として、旅行やモバイル利用に適した性能を提供します。
...
Beryl の[開封動画](../../video_library/unboxing_first_set_up.md#berylgl-mt1300)もご覧ください。
...
ワイヤレス設定では、メインWi-FiとゲストWi-Fiのネットワークセキュリティを管理できます。サイドメニューの **ワイヤレス** からアクセスできます。
