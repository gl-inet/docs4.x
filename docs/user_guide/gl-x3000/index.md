...
GL-X3000 (Spitz AX)はWi-Fi 6セルラーゲートウェイで、遠隔にでは信頼性の高いセルラーネットワークを、都市部では高速インターネットを提供するように設計されています。長距離接続のための6本の外部アンテナ、より強力な接続のISPを選択するための2枚のSIMカードおよびWANポート、SIMカード、リピータ間のマルチWANを備えています。
