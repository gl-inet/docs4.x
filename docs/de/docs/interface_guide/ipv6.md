...
![ipv6](https://static.gl-inet.com/docs/router/de/4/interface_guide/ipv6/ipv6.png){class="glboxshadow"}
...
![ipv6 enabled](https://static.gl-inet.com/docs/router/de/4/interface_guide/ipv6/ipv6_enabled.png){class="glboxshadow"}
