...
Dans la partie gauche du panneau d'administration web, accédez à **SYSTEM** -> **Time Zone**.

Le routeur enregistre les horodatages d'activité selon son heure système, et certaines fonctions dépendent d'une heure correcte pour fonctionner normalement. Assurez-vous que le bon fuseau horaire est sélectionné et synchronisé.
