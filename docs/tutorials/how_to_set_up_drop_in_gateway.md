...
**Please note**: Models with firmware versions below v4.5.0 lack the "Configuration method" option in both the app and the admin panel. Upon enabling the Drop-in Gateway, these models automatically operate in the "All devices are networked through drop-in gateway" mode.
