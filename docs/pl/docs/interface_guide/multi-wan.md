...
!!! Note
    ...
    3. Niektóre modele obsługują [podwójny WAN przez Ethernet](ethernet_port.md#dual-ethernet-wan), co dodaje dodatkowy interfejs Ethernet w interfejsie użytkownika.
