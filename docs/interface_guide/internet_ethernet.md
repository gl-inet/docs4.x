...
* Static
    ...
    ![ethernet static](/internet_ethernet/ethernet_static.png){class="glboxshadow"}
...
* PPPoE
    ...
    ![ethernet pppoe](/internet_ethernet/ethernet_pppoe.png){class="glboxshadow gl-90-desktop"}
