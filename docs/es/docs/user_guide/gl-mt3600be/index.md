# Guía de usuario de Beryl 7 (GL-MT3600BE)

## Descripción general del producto

Beryl 7 (GL-MT3600BE) es un router de viaje portátil Wi-Fi 7 de doble banda, diseñado específicamente para escenarios móviles como viajes de trabajo y vacaciones. Como versión mejorada de Beryl AX, es compatible con tecnologías Wi-Fi 7 como Multi-Link Operation (MLO) y 4K QAM, con velocidades teóricas de hasta 688 Mbps (2,4 GHz) + 2882 Mbps (5 GHz), suficientes para cubrir necesidades de alta velocidad como streaming 8K y juegos móviles.

Impulsado por un procesador MediaTek de cuatro núcleos y equipado con 512 MB de memoria flash NAND, garantiza multitarea estable y compatibilidad con diversos plug-ins de OpenWrt. Incorpora 2 puertos Ethernet 2.5G y 1 puerto USB 3.0, cubriendo tanto necesidades de conexión cableada de alta velocidad como de ampliación de almacenamiento. Gracias a su compatibilidad con PD, puede alimentarse mediante un cable estándar de cargador de teléfono, reduciendo el peso y el desorden en su equipaje. Capaz de admitir más de 120 dispositivos simultáneamente, presenta un diseño elegante y portátil pensado para la vida en movimiento.
...
- 3 x Convertidores (EU, UK y AU)

Vea a continuación el vídeo de unboxing de Beryl 7.
...
- Wi-Fi
  ...
  En su dispositivo, vaya a Settings -> WLAN, localice el nombre de la red Wi-Fi del router en la lista de redes disponibles e introduzca la contraseña para unirse a la red. (Puede encontrar el nombre de red y la contraseña predeterminados impresos en la etiqueta).
...
Configure su Beryl 7 con uno de los métodos de conexión a Internet compatibles: Ethernet, Repeater, Tethering y Cellular. Si desea utilizar la función [Multi-WAN](../../interface_guide/multi-wan.md), configure más de una conexión a Internet.
...
=== "Ethernet"
    ...
    Conecte el puerto WAN de Beryl 7 a un dispositivo aguas arriba, por ejemplo un módem, mediante un cable Ethernet.
...
=== "Tethering"
    ...
    1. Conecte su dispositivo móvil, por ejemplo un smartphone o un dongle USB, al puerto USB de Beryl 7 mediante un cable USB.
...
=== "Cellular"
    ...
    Conecte un módem USB celular al puerto USB de Beryl 7. Esto es útil para compartir Internet desde un módem USB con todos los dispositivos conectados.
...
A continuación se ofrece una visión general de las funciones del panel de administración web de Beryl 7.
...
Además, Beryl 7 es compatible con MLO Wi-Fi, es decir, Multi-Link Operation, que combina varias redes inalámbricas simultáneamente para lograr mayor ancho de banda y conexiones más fiables.
...
Una VPN (red privada virtual) crea tráfico seguro y cifrado entre su dispositivo y el servidor VPN. Proporciona una capa adicional de privacidad y seguridad cuando se usa como cliente VPN y permite acceder a una red remota cuando se usa como servidor VPN. Beryl 7 es compatible con OpenVPN, WireGuard y Tor.

=== "OpenVPN"

    Beryl 7, al igual que otros routers GL.iNet, es compatible con el protocolo OpenVPN, que ofrece una gran seguridad. Para configurar OpenVPN, siga estos tutoriales:
...
=== "WireGuard"
    ...
    Beryl 7, al igual que otros routers GL.iNet, es compatible con el protocolo WireGuard, que ofrece gran velocidad y comodidad de uso. Para configurar WireGuard, siga estos tutoriales:
...
Por la presente, GL TECHNOLOGIES (HONG KONG) LIMITED declara que el tipo de equipo radioeléctrico [BE3600 Dual-band Wi-Fi7 Travel Router, GL-MT3600BE] es conforme con los requisitos esenciales y demás disposiciones pertinentes de la Directiva 2014/53/UE. El texto completo de la declaración UE de conformidad está disponible en la dirección Internet siguiente: [https://www.gl-inet.com/products/certificate](https://www.gl-inet.com/products/certificate){target="_blank"}.