...
1. Nie zaleca się używania AstroWarp jednocześnie z żadną z następujących funkcji, ponieważ może to powodować konflikty routingu: GoodCloud Site to Site, ZeroTier, Tailscale, Tor.
2. Gdy AstroWarp jest włączony, nie można używać funkcji Network Mode.
