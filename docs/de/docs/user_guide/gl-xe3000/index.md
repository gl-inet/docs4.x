...
Richten Sie Puli AX mit einer der unterstützten Internetverbindungsmethoden ein: Cellular, Ethernet, Repeater, and Tethering. If you want to use the [Multi-WAN](../../interface_guide/multi-wan.md) feature, please set up more than one internet connection.
