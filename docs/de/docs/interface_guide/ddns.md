...
![ddns](https://static.gl-inet.com/docs/router/de/4/interface_guide/ddns/ddns.png){class="glboxshadow"}

Aktivieren Sie **Enable DDNS**, stimmen Sie den **Terms of Services & Privacy Policy** zu und klicken Sie dann auf **Apply**.

![enable ddns](https://static.gl-inet.com/docs/router/de/4/interface_guide/ddns/enable_ddns.png){class="glboxshadow"}

Klicken Sie unten rechts auf **Security Settings**.

![security settings](https://static.gl-inet.com/docs/router/de/4/interface_guide/ddns/security_settings-1.png){class="glboxshadow"}
...
![security settings](https://static.gl-inet.com/docs/router/de/4/interface_guide/ddns/security_settings-2.png){class="glboxshadow"}

Aktivieren Sie das gewünschte Fernzugriffsprotokoll und klicken Sie auf **Apply**.

![security remote access](https://static.gl-inet.com/docs/router/de/4/interface_guide/ddns/remote_access_enabled.jpg){class="glboxshadow"}
...
=== "DDNS-Testwerkzeug verwenden"
    ...
    ![ddns test](https://static.gl-inet.com/docs/router/de/4/interface_guide/ddns/ddns_test.png){class="glboxshadow"}
...
2. Gehen Sie im webbasierten Admin Panel zu SYSTEM -> Security -> Remote Access Control.
    ...
    ![remote access control](https://static.gl-inet.com/docs/router/de/4/interface_guide/ddns/remote_access_disabled.png){class="glboxshadow"}

3. Aktivieren Sie **HTTPS Remote Access** und klicken Sie auf **Apply**.

    ![enable https remote access](https://static.gl-inet.com/docs/router/de/4/interface_guide/ddns/enable_https_remote_access.png){class="glboxshadow"}
...
![HTTPS-Remote-Access-on-Android-Chrome](https://static.gl-inet.com/docs/router/de/4/interface_guide/ddns/https_remote_access_android_chrome_0.jpg){class="glboxshadow" width="400"}

Um mit dem HTTPS-Fernzugriff fortzufahren, klicken Sie unten auf **Advanced**.

![HTTPS-Remote-Access-on-Android-Chrome](https://static.gl-inet.com/docs/router/de/4/interface_guide/ddns/https_remote_access_android_chrome_1.png){class="glboxshadow" width="400"}

Klicken Sie anschließend auf **Proceed to xxxxxxx.glddns.com**, um fortzufahren.

![HTTPS-Remote-Access-on-Android-Chrome](https://static.gl-inet.com/docs/router/de/4/interface_guide/ddns/https_remote_access_android_chrome_2.png){class="glboxshadow" width="400"}

Danach können Sie das webbasierte Admin Panel über den DDNS-Hostnamen per HTTPS aufrufen.

![HTTPS-Remote-Access-on-Android-Chrome](https://static.gl-inet.com/docs/router/de/4/interface_guide/ddns/https_remote_access_android_chrome_3.png){class="glboxshadow" width="400"}
...
3. Aktivieren Sie **SSH Remote Access** und klicken Sie auf **Apply**.
    ...
    ![enable ssh remote access](https://static.gl-inet.com/docs/router/de/4/interface_guide/ddns/enable_ssh_remote_access.png){class="glboxshadow"}
