# GoodCloud経よりでLuCIインターフェースにアクセスする方法
...
## GoodCloud経よりでLuCIインターフェースにアクセスする手順
...
2. 左側 -> **Devices** -> **Bound Devices**、アクセスしたい機器の名前をクリックすると、Remote Web Accessのアイコンが表示されます。
    ...
    ポップアップウィンドウにポート80が表示されます。ポートを**8080**に変よりし、Applyをクリックします。
...
4. ログイン後、左側 -> SYSTEM -> Advanced Settings、LuCIインターフェースに移動するハイパーリンクをクリックします。
    ...
    LuCIログインページにリダイレクトされます。 same じ管理者パスワードを入力してログインします。
