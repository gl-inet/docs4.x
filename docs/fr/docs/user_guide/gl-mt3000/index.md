# Guide d'utilisation de Beryl AX (GL-MT3000)

## Aperçu du produit

Beryl AX (GL-MT3000) est un routeur de voyage de poche AX3000 utilisant le protocole Wi‑Fi 6. Il s'agit d'une version améliorée du Beryl (GL-MT1300). Équipé d'un processeur double cœur MT7981B à 1,3 GHz, il offre plus du double de la vitesse Wi‑Fi totale. Il est conçu pour les familles ayant une utilisation intensive du Wi‑Fi tout en restant suffisamment compact pour les déplacements.
...
Configurez votre Beryl AX en utilisant l'une des méthodes de connexion Internet prises en charge : Ethernet, Repeater, Tethering et Cellular. Si vous souhaitez utiliser la fonction [Multi-WAN](../../interface_guide/multi-wan.md), veuillez configurer plus d'une connexion Internet.
...
=== "Ethernet"
    ...
    Branchez un câble Ethernet entre le port WAN de votre routeur et un équipement amont (par exemple un modem).
...
=== "WireGuard"
    ...
    Beryl AX (comme les autres routeurs GL.iNet) prend en charge le protocole WireGuard, qui offre d'excellentes vitesses et une grande simplicité d'utilisation. Pour configurer WireGuard, suivez ces tutoriels :
...
=== "Contrôle parental"
    ...
    Le contrôle parental est conçu pour vous aider à gérer et à contrôler les appareils de vos enfants. Il permet notamment de limiter leur temps d'écran et de restreindre l'accès à certains contenus.
