...
1. Wenn keine SIM-Karte eingesetzt ist, zeigt die Seite die Meldung „Your SIM card has not been detected“ an.
    ...
    ![single no sim](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/single_no_sim.png){class="glboxshadow"}

2. Setzen Sie eine SIM-Karte ein. Das Gerät beginnt dann wie unten dargestellt mit dem Verbindungsaufbau.

    ![single sim connecting](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/single_sim_connecting.png){class="glboxshadow"}
...
3. Sobald die Mobilfunkverbindung hergestellt ist, zeigt die Seite die Netzwerkdetails mit einem grünen Punkt an, was auf eine erfolgreiche Verbindung hinweist.
    ...
    ![single sim connected](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/single_sim_connected.png){class="glboxshadow"}
...
![sim card settings](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/single_sim_settings_1.png){class="glboxshadow"}
...
![single sim card settings 1](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/single_sim_settings_2.png){class="glboxshadow"}
...
- **TTL**: TTL (Time To Live) definiert, wie lange Pakete maximal im Netzwerk überleben können. Standardmäßig verringert der Router die TTL eingehender Pakete von Client-Geräten vor der Weiterleitung um 1. Die TTL-Einstellung gilt nur für IPv4.
    ...
    **Hinweis**: Wenn Sie sie überschreiben müssen, können Sie hier einen festen Wert festlegen. Geben Sie bei den meisten Modellen die gewünschte effektive TTL plus 1 ein, um die automatische Verringerung auszugleichen. Beim Mudi 7 (GL-E5800) wird der eingegebene Wert unverändert angewendet.
...
1. Wenn keine SIM-Karte eingesetzt ist, zeigt die Seite die Meldung „Your SIM card has not been detected“ an.
    ...
    ![no sim](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/no_sim.png){class="glboxshadow"}

2. Wenn eine SIM-Karte eingesetzt ist, wird die Seite wie folgt angezeigt. Klicken Sie auf **Connect**.

    ![cellular unconnected](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/cellular_unconnected.png){class="glboxshadow"}

    Wenn die SIM-Karte nicht erkannt wird, versuchen Sie, den Router neu zu starten, um zu prüfen, ob sie dann erkannt wird.

3. Sobald die Mobilfunkverbindung hergestellt ist, zeigt die Seite die Netzwerkdetails mit einem grünen Punkt an, was auf eine erfolgreiche Verbindung hinweist.

    ![cellular connected](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/cellular_connected.png){class="glboxshadow"}
...
4. Klicken Sie auf **View More Information**, um weitere Mobilfunkinformationen anzuzeigen, einschließlich Modemdetails, SIM-Kartendetails, Internetdetails und Mobilfunksignal.
    ...
    ![view more info](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/view_more_info.png){class="glboxshadow"}

    ![cellular info](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/cellular_info.jpg){class="glboxshadow gl-90-desktop"}
...
![sim card settings 1](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/sim_card_settings_1.png){class="glboxshadow"}
...
![sim card settings 2](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/sim_card_settings_2.png){class="glboxshadow"}
...
![sim card switch](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/slot_settings_0.png){class="glboxshadow"}
...
![slot_settings_1](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/slot_settings_1.png){class="glboxshadow"}

Wenn zwei SIM-Karten eingesetzt sind, können Sie **Auto Switch** aktivieren.

![slot_settings_2](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/slot_settings_2.png){class="glboxshadow"}
...
- **Failover Interval**: Verfügbare Werte reichen von 5 Minuten bis 24 Stunden.
    ...
    ![failover interval](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/sim_failover_interval.png){class="glboxshadow"}
...
- **Checking Preferred Slot Status Scheduled**
    ...
    ![checking preferred slot status scheduled](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/check_preferred_slot_status.png){class="glboxshadow"}
...
2. Melden Sie sich am webbasierten Admin Panel des Routers an, navigieren Sie zu **INTERNET** -> **Tethering** und klicken Sie dann auf **Connect**.
    ...
    ![usb modem 1](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/usb_modem_1.png){class="glboxshadow"}
    ...
    ![usb modem 2](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/usb_modem_2.png){class="glboxshadow"}

    Der Verbindungsaufbau wird gestartet.

    ![usb modem 3](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/usb_modem_3.png){class="glboxshadow"}
...
3. Sobald die Verbindung hergestellt ist, zeigt die Seite die Netzwerkdetails mit einem grünen Punkt an, was auf eine erfolgreiche Verbindung hinweist.
    ...
    ![usb modem 4](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/usb_modem_4.png){class="glboxshadow"}
...
![traffic statistics](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/traffic_statistics_0.png){class="glboxshadow"}
...
![traffic statistics 1](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/traffic_statistics_1.png){class="glboxshadow"}
...
- **Data Used ändern**
    ...
    ![traffic statistics 2](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/traffic_statistics_2.jpg){class="glboxshadow"}

    Anschließend können Sie den Datenverbrauch ändern oder zurücksetzen.

    ![traffic statistics 3](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/traffic_statistics_3_new.png){class="glboxshadow"}
...
- **SIM-Datenlimit einrichten**
    ...
    ![traffic statistics 4](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/traffic_statistics_4.png){class="glboxshadow"}

    Aktivieren Sie anschließend die Limit Settings für SIM 1 oder SIM 2.

    ![traffic statistics 5](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/traffic_statistics_5.jpg){class="glboxshadow"}
...
![historical signal record](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/historical_signal_record_0.png){class="glboxshadow"}
...
![historical signal record 1](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/historical_signal_record_1.png){class="glboxshadow"}

![historical signal record 2](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/historical_signal_record_2.png){class="glboxshadow"}

Den Verlauf der Signalstärke können Sie anzeigen, indem Sie oben rechts unterschiedliche Zeiträume auswählen.

![historical signal record 3](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/historical_signal_record_3.png){class="glboxshadow"}
...
![single sim band masking](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/single_sim_band_masking.png){class="glboxshadow"}
...
![lock tower 0](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/lock_tower_0.png){class="glboxshadow"}
...
![lock tower 1](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/lock_tower_1.png){class="glboxshadow"}

Daraufhin werden die verfügbaren Masten angezeigt.

![lock tower 2](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/lock_tower_2.png){class="glboxshadow"}

Klicken Sie auf einen Mast, um die Details anzuzeigen und ihn zu sperren.

![lock tower 3](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/lock_tower_3.png){class="glboxshadow"}
...
![lock operator 0](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/lock_operator_0.png){class="glboxshadow"}
...
![lock operator 1](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/lock_operator_1.png){class="glboxshadow"}
...
![AT command 0](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/at_command_0.jpg){class="glboxshadow"}

Sie gelangen auf die Seite **AT Command**.

![AT command 1](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/at_command_1.png){class="glboxshadow"}
...
![AT command 2](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/at_command_2.png){class="glboxshadow"}
...
![AT command 3](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/at_command_3.png){class="glboxshadow"}

Unten rechts können Sie auf **Export Debug Info** klicken, um eine `.json`-Datei herunterzuladen.

![AT command 4](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/at_command_4.png){class="glboxshadow"}
...
??? note "No SIM / Your SIM card has not been detected"
    ...
    ![no sim](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/troubleshoot/no_sim.png){class="glboxshadow"}
...
??? note "SIM card not registered / The interface is connected, but the Internet can't be accessed"
    ...
    - SIM card not registered
        ...
        ![sim not registered](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/troubleshoot/sim_not_registered.png){class="glboxshadow"}

    - The interface is connected, but the Internet can't be accessed

        ![connected no internet](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/troubleshoot/connected_no_internet.png){class="glboxshadow"}
    ...
    5. Manche Netzbetreiber benötigen für die Netzverbindung möglicherweise das 3G-Protokoll. Gehen Sie zu **SIM Card Settings** -> **Protocol**, wählen Sie **3G** und klicken Sie anschließend auf **Apply**.
        ...
        ![sim protocol](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/troubleshoot/sim_settings_protocol.png){class="glboxshadow gl-80-desktop"}
        ...
        ![connecting](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/troubleshoot/connecting.png){class="glboxshadow"}

        Wenn die Verbindung erfolgreich ist, wird die Seite wie folgt angezeigt.

        ![connected](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/troubleshoot/connected.png){class="glboxshadow"}
    ...
    6. Manche SIM-Karten haben besondere Nutzungseinschränkungen, z. B. die Vorgabe eines bestimmten APN. Wenn Ihre SIM-Karte sich nicht registrieren kann, kontaktieren Sie Ihren Anbieter und prüfen Sie, ob Einschränkungen vorliegen.
        ...
        ![sim apn](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/troubleshoot/sim_settings_apn.png){class="glboxshadow gl-80-desktop"}
    ...
    7. Klicken Sie auf **View More Information**, um die Mobilfunk-Signalstärke zu prüfen. Wenn das Signal schwach ist, stellen Sie sicher, dass die Antenne korrekt installiert ist. Platzieren Sie den Router an einem offenen und möglichst unverbauten Standort, um den Signalempfang zu verbessern.
        ...
        ![cells signal](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/4.8/troubleshoot/cells_info.png){class="glboxshadow gl-80-desktop"}
...
![bandmasking](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/certification/at&t_certification.png){class="glboxshadow"}

![bandmasking](https://static.gl-inet.com/docs/router/de/4/interface_guide/internet_cellular/certification/at&t_certification_2.png){class="glboxshadow"}
