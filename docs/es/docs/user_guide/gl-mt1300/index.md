# Guía de usuario de Beryl (GL-MT1300)

## Descripción general del producto

Beryl (GL-MT1300) es un router de bolsillo de alto rendimiento que ofrece hardware potente y protocolos de ciberseguridad de primer nivel, con un diseño único y moderno. Como versión avanzada de nuestro producto más vendido, Slate (GL-AR750S), Beryl representa una nueva generación de router de viaje.
...
Vea el [video de unboxing](../../video_library/unboxing_first_set_up.md/#gl-mt1300-beryl) de Beryl.
...
Los routers GL.iNet incluyen cliente y servidor VPN preinstalados para OpenVPN y WireGuard.
...
Consulte los enlaces siguientes para ver instrucciones detalladas de configuración:
...
Anteriormente se llamaba [Hardware Acceleration](../../interface_guide/hardware_acceleration.md).

Visite el tutorial [**Network Acceleration**](../../interface_guide/network_acceleration.md).
