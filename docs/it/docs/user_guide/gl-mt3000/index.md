# Guida utente di Beryl AX (GL-MT3000)

## Panoramica del prodotto

Beryl AX (GL-MT3000) e un travel router tascabile AX3000 che utilizza il protocollo Wi-Fi 6. E una versione aggiornata di Beryl (GL-MT1300). Basato su processore dual-core MT7981B da 1,3 GHz, offre oltre il doppio della velocita Wi-Fi complessiva. E progettato per supportare famiglie con un uso intensivo del Wi-Fi ed e anche compatto per l'uso in viaggio.
...
Configura Beryl AX usando uno dei metodi di connessione Internet supportati: Ethernet, Repeater, Tethering e Cellular. Se desideri usare la funzione [Multi-WAN](../../interface_guide/multi-wan.md), configura piu di una connessione Internet.
...
Una VPN crea traffico sicuro e crittografato tra il dispositivo e il server VPN. Offre un ulteriore livello di privacy e sicurezza come client VPN e consente di accedere a una rete remota come server VPN. Beryl AX, come gli altri router GL.iNet, supporta OpenVPN e WireGuard. Inoltre supporta anche Tor.

=== "OpenVPN"

    Beryl AX, come gli altri router GL.iNet, supporta il protocollo OpenVPN, che offre un elevato livello di sicurezza. Per configurare OpenVPN, segui questi tutorial:
...
=== "WireGuard"
    ...
    Beryl AX, come gli altri router GL.iNet, supporta il protocollo WireGuard, che offre ottima velocita e praticita. Per configurare WireGuard, segui questi tutorial:
...
=== "Wireless"
    ...
    La pagina Wireless consente di configurare le impostazioni delle reti Wi-Fi a 5 GHz e 2,4 GHz, tra cui attivazione e disattivazione del Wi-Fi, potenza TX, nome della rete Wi-Fi (SSID), BSSID casuale, modalita di sicurezza Wi-Fi, password Wi-Fi, visibilita dell'SSID, modalita Wi-Fi, larghezza di banda e canale.

    Per configurarla, fai riferimento a [Wireless](../../interface_guide/wireless.md).

=== "Clients"

    La pagina Clients mostra informazioni sui dispositivi collegati. Per ogni client visualizza nome del dispositivo, tipo di connessione, via Ethernet o Wi-Fi, indirizzi IP e MAC, velocita di download e upload, traffico totale e offre la possibilita di riservare un IP, bloccare il client o eseguire altre azioni.
...
=== "Port Management"
    ...
    La pagina Port Management consente di configurare le porte WAN e LAN, impostare l'interfaccia WAN/LAN su Ethernet, specificare la modalita MAC e l'indirizzo MAC per l'interfaccia WAN e visualizzare la velocita negoziata della porta di rete.
