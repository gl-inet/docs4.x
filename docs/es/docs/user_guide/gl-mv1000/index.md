# Guía de usuario de Brume (GL-MV1000)

## Descripción general del producto

Brume (GL-MV1000) y Brume-W (GL-MV1000W) son productos de red potentes y estables, diseñados para ofrecer computación avanzada. Gracias al chipset de alto rendimiento de Marvell, Brume y Brume-W pueden ejecutar criptografía de última generación a velocidades impresionantes para ofrecer una excelente experiencia de enrutamiento VPN. Con OpenWrt preinstalado y compatibilidad con Ubuntu, Brume y Brume-W permiten desarrollos profundos para proyectos comerciales de IoT.

Brume-W (GL-MV1000W) es la edición especial de Brume (GL-MV1000) que incorpora un módulo Wi-Fi integrado, capaz de ofrecer un alto rendimiento en Wi-Fi de 2.4 GHz con velocidades de hasta 300 Mbps.
...
En el caso de Brume (GL-MV1000), admite tres tipos de conexión: Ethernet, Tethering y Cellular.
...
Conecte el router a Internet enchufando un módem USB con capacidad celular al puerto USB del router. Este método es útil para compartir Internet desde un módem USB con todos los dispositivos conectados.
