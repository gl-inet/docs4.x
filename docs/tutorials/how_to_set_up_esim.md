...
- **E750V1※/E750V2**: Please upgrade the [firmware](http://download.gl-inet.com/firmware/e750/esim){target="_blank"} that supports eSIM.
- **X3000**: Please upgrade to the [firmware](http://download.gl-inet.com/firmware/x3000/esim){target="_blank"} that supports eSIM.
- **XE3000**: Please upgrade to the [firmware](http://download.gl-inet.com/firmware/xe3000/esim){target="_blank"} that supports eSIM.
- **XE300※**: Please upgrade to the [firmware](http://download.gl-inet.com/firmware/xe300/esim){target="_blank"} that supports eSIM.
- **X750V1※/X750V2※**: Please upgrade to the [firmware](http://download.gl-inet.com/firmware/x750/esim){target="_blank"} that supports eSIM.
- **X300B**: Please upgrade to the [firmware](http://download.gl-inet.com/firmware/x300b/esim){target="_blank"} that supports eSIM.
