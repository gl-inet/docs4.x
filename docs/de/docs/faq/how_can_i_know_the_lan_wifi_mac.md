...
![wan_lan_wifi](https://static.gl-inet.com/docs/router/de/4/faq/how_can_i_know_the_lan_wifi_mac/wan_lan_wifi.png){class="glboxshadow"}
...
![ifconfigwan](https://static.gl-inet.com/docs/router/de/4/faq/how_can_i_know_the_lan_wifi_mac/ifcongwan.jpg){class="glboxshadow"}
...
![ifconfigwifi](https://static.gl-inet.com/docs/router/de/4/faq/how_can_i_know_the_lan_wifi_mac/ifcongwifi.jpg){class="glboxshadow"}
